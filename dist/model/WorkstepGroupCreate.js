...
exports.WorkstepGroupCreate = void 0;
...
/**
 * The WorkstepGroupCreate model module.
 * @module model/WorkstepGroupCreate
 * @version 1.0.0
 */
var WorkstepGroupCreate = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>WorkstepGroupCreate</code>.
   * @alias module:model/WorkstepGroupCreate
   * @class
   */
  function WorkstepGroupCreate() {
    _classCallCheck(this, WorkstepGroupCreate);
  }

  /**
   * Constructs a <code>WorkstepGroupCreate</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/WorkstepGroupCreate} obj Optional instance to populate.
   * @return {module:model/WorkstepGroupCreate} The populated <code>WorkstepGroupCreate</code> instance.
   */
  _createClass(WorkstepGroupCreate, null, [{
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new WorkstepGroupCreate();
  ...
  return WorkstepGroupCreate;
}();
/**
 * @member {String} id
 */
exports.WorkstepGroupCreate = WorkstepGroupCreate;
WorkstepGroupCreate.prototype.id = undefined;
 ...
 * @member {module:model/WorkstepGroupCreate.KindEnum} kind
 */
WorkstepGroupCreate.prototype.kind = undefined;

/**
 * The current completion percentage of all worksteps within this group
 * @member {String} completionPercent
 */
WorkstepGroupCreate.prototype.completionPercent = undefined;
 ...
 */
WorkstepGroupCreate.prototype.managed = undefined;