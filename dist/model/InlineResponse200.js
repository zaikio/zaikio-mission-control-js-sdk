...
var InlineResponse200 = /*#__PURE__*/function (_Job) {
   ...
   */
  function InlineResponse200(parts, id, createdAt, updatedAt, name, references, kind, source, version, quantity, acceptableQuantityExcess, acceptableQuantityUnderrun, dueAt, estimatedCompletedAt) {
    var _this;
    _classCallCheck(this, InlineResponse200);
    _this = _super.call(this, id, createdAt, updatedAt, name, references, kind, source, version, quantity, acceptableQuantityExcess, acceptableQuantityUnderrun, dueAt, estimatedCompletedAt);
    _this.parts = parts;
    return _this;
  }
