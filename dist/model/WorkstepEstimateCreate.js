...
exports.WorkstepEstimateCreate = void 0;
...
/**
 * The WorkstepEstimateCreate model module.
 * @module model/WorkstepEstimateCreate
 * @version 1.0.0
 */
var WorkstepEstimateCreate = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>WorkstepEstimateCreate</code>.
   * @alias module:model/WorkstepEstimateCreate
   * @class
   */
  function WorkstepEstimateCreate() {
    _classCallCheck(this, WorkstepEstimateCreate);
  }

  /**
   * Constructs a <code>WorkstepEstimateCreate</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/WorkstepEstimateCreate} obj Optional instance to populate.
   * @return {module:model/WorkstepEstimateCreate} The populated <code>WorkstepEstimateCreate</code> instance.
   */
  _createClass(WorkstepEstimateCreate, null, [{
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new WorkstepEstimateCreate();
        ...
        if (data.hasOwnProperty('material_costs')) obj.materialCosts = _ApiClient.ApiClient.convertToType(data['material_costs'], 'Number');
      }
      return obj;
    }
  }]);
  return WorkstepEstimateCreate;
}();
/**
 * @member {String} estimateId
 */
exports.WorkstepEstimateCreate = WorkstepEstimateCreate;
WorkstepEstimateCreate.prototype.estimateId = undefined;
 ...
 * @readonly
 */
WorkstepEstimateCreate.WorkpieceTypeEnum = {
  /**
   * value: "Job"
   * @const
   */
 ...
 * @member {module:model/WorkstepEstimateCreate.WorkpieceTypeEnum} workpieceType
 */
WorkstepEstimateCreate.prototype.workpieceType = undefined;

/**
 * @member {String} workpieceId
 */
WorkstepEstimateCreate.prototype.workpieceId = undefined;
 ...
 * @readonly
 */
WorkstepEstimateCreate.KindEnum = {
  /**
   * value: "addressing"
   * @const
   */
 ...
 * @member {module:model/WorkstepEstimateCreate.KindEnum} kind
 */
WorkstepEstimateCreate.prototype.kind = undefined;

/**
 * A more detailed description of the workstep than `kind`. It is optional, but must be filled out if `kind` is set to `other`.
 * @member {String} description
 */
WorkstepEstimateCreate.prototype.description = undefined;
 ...
 */
WorkstepEstimateCreate.prototype.internalLaborCosts = undefined;
 ...
 */
WorkstepEstimateCreate.prototype.externalLaborCosts = undefined;
 ...
 */
WorkstepEstimateCreate.prototype.durationForPreparation = undefined;

/**
 * The estimated time in seconds that is required to execute of the estimated workstep.
 * @member {Number} durationForExecution
 */
WorkstepEstimateCreate.prototype.durationForExecution = undefined;
 ...
 */
WorkstepEstimateCreate.prototype.durationForCleanup = undefined;

/**
 * @member {Number} materialCosts
 */
WorkstepEstimateCreate.prototype.materialCosts = undefined;