 ...
 * @version 1.0.0
 */
var Lamination = /*#__PURE__*/function () {
  /**
   ...
   */
  function Lamination(id, createdAt, updatedAt, fileReferences, kind, method, texture, color) {
    _classCallCheck(this, Lamination);
    this.id = id;
