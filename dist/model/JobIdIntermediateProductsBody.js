...
exports.JobIdIntermediateProductsBody = void 0;
 ...
 * @version 1.0.0
 */
var JobIdIntermediateProductsBody = /*#__PURE__*/function () {
  /**
   ...
   */
  function JobIdIntermediateProductsBody(intermediateProduct) {
    _classCallCheck(this, JobIdIntermediateProductsBody);
   ...
   */
  _createClass(JobIdIntermediateProductsBody, null, [{
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new JobIdIntermediateProductsBody();
        if (data.hasOwnProperty('intermediate_product')) obj.intermediateProduct = _IntermediateProductCreate.IntermediateProductCreate.constructFromObject(data['intermediate_product']);
      }
      return obj;
    }
  }]);
  return JobIdIntermediateProductsBody;
}();
/**
 * @member {module:model/IntermediateProductCreate} intermediateProduct
 */
exports.JobIdIntermediateProductsBody = JobIdIntermediateProductsBody;
