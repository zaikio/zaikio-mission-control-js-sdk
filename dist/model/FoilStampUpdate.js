...
exports.FoilStampUpdate = void 0;
 ...
 * @version 1.0.0
 */
var FoilStampUpdate = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>FoilStampUpdate</code>.
   * @alias module:model/FoilStampUpdate
   * @class
   */
  function FoilStampUpdate() {
    _classCallCheck(this, FoilStampUpdate);
  }
   ...
   */
  _createClass(FoilStampUpdate, null, [{
  ...
  return FoilStampUpdate;
}();
/**
 * @member {Array.<module:model/FileReferenceUpdate>} fileReferences
 */
exports.FoilStampUpdate = FoilStampUpdate;
