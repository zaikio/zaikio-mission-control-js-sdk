 ...
 * @version 1.0.0
 */
var LessThanUpdate = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>LessThanUpdate</code>.
   * @alias module:model/LessThanUpdate
   * @class
   */
  function LessThanUpdate() {
    _classCallCheck(this, LessThanUpdate);
  }
   ...
   */
  _createClass(LessThanUpdate, null, [{
  ...
  return LessThanUpdate;
}(); // Implement RuleUpdate interface:
exports.LessThanUpdate = LessThanUpdate;