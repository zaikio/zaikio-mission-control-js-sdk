...
exports.LaminationUpdate = void 0;
 ...
 * @version 1.0.0
 */
var LaminationUpdate = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>LaminationUpdate</code>.
   * @alias module:model/LaminationUpdate
   * @class
   */
  function LaminationUpdate() {
    _classCallCheck(this, LaminationUpdate);
  }
   ...
   */
  _createClass(LaminationUpdate, null, [{
  ...
  return LaminationUpdate;
}();
/**
 * @member {Array.<module:model/FileReferenceUpdate>} fileReferences
 */
exports.LaminationUpdate = LaminationUpdate;
