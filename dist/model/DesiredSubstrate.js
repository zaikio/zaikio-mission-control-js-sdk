...
exports.DesiredSubstrate = void 0;
 ...
 * @version 1.0.0
 */
var DesiredSubstrate = /*#__PURE__*/function () {
  /**
   ...
   */
  function DesiredSubstrate(id, createdAt, updatedAt, uniqueMaterialIdentifier, category, paperWeight, paperWeightUnit, coating, grain) {
    _classCallCheck(this, DesiredSubstrate);
    this.id = id;
   ...
   */
  _createClass(DesiredSubstrate, null, [{
  ...
  return DesiredSubstrate;
}();
/**
 * @member {String} id
 */
exports.DesiredSubstrate = DesiredSubstrate;
