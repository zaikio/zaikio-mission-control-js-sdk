 ...
 * @version 1.0.0
 */
var HeadBand = /*#__PURE__*/function () {
  /**
   ...
   */
  function HeadBand(id, createdAt, updatedAt, fileReferences, kind, color, length, width, dimensionsUnit) {
    _classCallCheck(this, HeadBand);
    this.id = id;
