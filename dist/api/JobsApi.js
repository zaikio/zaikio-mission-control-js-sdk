...
var JobsApi = /*#__PURE__*/function () {
  ...
  */
  ...
  _createClass(JobsApi, [{
    ...
    key: "jobsJobIdStateTransitionsGetWithHttpInfo",
    value: function jobsJobIdStateTransitionsGetWithHttpInfo(jobId, opts) {
      opts = opts || {};
      var postBody = null;
      // verify the required parameter 'jobId' is set
      if (jobId === undefined || jobId === null) {
      ...
      var contentTypes = [];
      var accepts = ['application/json'];
      var returnType = [_JobStateTransition.JobStateTransition];
      return this.apiClient.callApi('/jobs/{job_id}/state_transitions', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType);
    }
    ...
    key: "jobsJobIdStateTransitionsGet",
    value: function jobsJobIdStateTransitionsGet(jobId, opts) {
      return this.jobsJobIdStateTransitionsGetWithHttpInfo(jobId, opts).then(function (response_and_data) {
        return response_and_data.data;
      });
    }
    ...
    key: "jobsJobIdStateTransitionsPostWithHttpInfo",
    value: function jobsJobIdStateTransitionsPostWithHttpInfo(body, jobId) {
      var postBody = body;
      // verify the required parameter 'body' is set
      if (body === undefined || body === null) {
      ...
      var accepts = ['application/json'];
      var returnType = _JobStateTransition.JobStateTransition;
      return this.apiClient.callApi('/jobs/{job_id}/state_transitions', 'POST', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType);
    }
    ...
    key: "jobsJobIdStateTransitionsPost",
    value: function jobsJobIdStateTransitionsPost(body, jobId) {
      return this.jobsJobIdStateTransitionsPostWithHttpInfo(body, jobId).then(function (response_and_data) {
        return response_and_data.data;
      });
    }
    ...
    key: "jobsJobIdStateTransitionsStateTransitionIdGetWithHttpInfo",
    value: function jobsJobIdStateTransitionsStateTransitionIdGetWithHttpInfo(jobId, stateTransitionId) {
      var postBody = null;
      // verify the required parameter 'jobId' is set
      if (jobId === undefined || jobId === null) {
      ...
      var accepts = ['application/json'];
      var returnType = _JobStateTransition.JobStateTransition;
      return this.apiClient.callApi('/jobs/{job_id}/state_transitions/{state_transition_id}', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType);
    }
    ...
    key: "jobsJobIdStateTransitionsStateTransitionIdGet",
    value: function jobsJobIdStateTransitionsStateTransitionIdGet(jobId, stateTransitionId) {
      return this.jobsJobIdStateTransitionsStateTransitionIdGetWithHttpInfo(jobId, stateTransitionId).then(function (response_and_data) {
        return response_and_data.data;
      });
    }
