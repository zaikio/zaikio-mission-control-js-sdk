...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('OrderIdPaymentTermsBody', function() {
      beforeEach(function() {
        instance = new MissionControl.OrderIdPaymentTermsBody();
      });

      it('should create an instance of OrderIdPaymentTermsBody', function() {
        // TODO: update the code to test OrderIdPaymentTermsBody
        expect(instance).to.be.a(MissionControl.OrderIdPaymentTermsBody);
      });
