...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ShipmentCreate', function() {
      beforeEach(function() {
        instance = new MissionControl.ShipmentCreate();
      });

      it('should create an instance of ShipmentCreate', function() {
        // TODO: update the code to test ShipmentCreate
        expect(instance).to.be.a(MissionControl.ShipmentCreate);
      });
