...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('BoxModelIntermediateLayout', function() {
      beforeEach(function() {
        instance = new MissionControl.BoxModelIntermediateLayout();
      });

      it('should create an instance of BoxModelIntermediateLayout', function() {
        // TODO: update the code to test BoxModelIntermediateLayout
        expect(instance).to.be.a(MissionControl.BoxModelIntermediateLayout);
      });
