...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('StringEndsUpdate', function() {
      beforeEach(function() {
        instance = new MissionControl.StringEndsUpdate();
      });

      it('should create an instance of StringEndsUpdate', function() {
        // TODO: update the code to test StringEndsUpdate
        expect(instance).to.be.a(MissionControl.StringEndsUpdate);
      });
