...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PerfectBinding', function() {
      beforeEach(function() {
        instance = new MissionControl.PerfectBinding();
      });

      it('should create an instance of PerfectBinding', function() {
        // TODO: update the code to test PerfectBinding
        expect(instance).to.be.a(MissionControl.PerfectBinding);
      });
