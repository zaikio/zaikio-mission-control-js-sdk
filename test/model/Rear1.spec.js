...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Rear1', function() {
      beforeEach(function() {
        instance = new MissionControl.Rear1();
      });

      it('should create an instance of Rear1', function() {
        // TODO: update the code to test Rear1
        expect(instance).to.be.a(MissionControl.Rear1);
      });
