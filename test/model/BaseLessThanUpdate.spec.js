...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('BaseLessThanUpdate', function() {
      beforeEach(function() {
        instance = new MissionControl.BaseLessThanUpdate();
      });

      it('should create an instance of BaseLessThanUpdate', function() {
        // TODO: update the code to test BaseLessThanUpdate
        expect(instance).to.be.a(MissionControl.BaseLessThanUpdate);
      });
