...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('HeadBandCreate', function() {
      beforeEach(function() {
        instance = new MissionControl.HeadBandCreate();
      });

      it('should create an instance of HeadBandCreate', function() {
        // TODO: update the code to test HeadBandCreate
        expect(instance).to.be.a(MissionControl.HeadBandCreate);
      });
