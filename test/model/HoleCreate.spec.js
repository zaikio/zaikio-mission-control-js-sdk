...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('HoleCreate', function() {
      beforeEach(function() {
        instance = new MissionControl.HoleCreate();
      });

      it('should create an instance of HoleCreate', function() {
        // TODO: update the code to test HoleCreate
        expect(instance).to.be.a(MissionControl.HoleCreate);
      });
