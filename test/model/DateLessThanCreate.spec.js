...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DateLessThanCreate', function() {
      beforeEach(function() {
        instance = new MissionControl.DateLessThanCreate();
      });

      it('should create an instance of DateLessThanCreate', function() {
        // TODO: update the code to test DateLessThanCreate
        expect(instance).to.be.a(MissionControl.DateLessThanCreate);
      });
