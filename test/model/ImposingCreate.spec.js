...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ImposingCreate', function() {
      beforeEach(function() {
        instance = new MissionControl.ImposingCreate();
      });

      it('should create an instance of ImposingCreate', function() {
        // TODO: update the code to test ImposingCreate
        expect(instance).to.be.a(MissionControl.ImposingCreate);
      });
