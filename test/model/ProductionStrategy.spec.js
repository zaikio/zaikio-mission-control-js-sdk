...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ProductionStrategy', function() {
      beforeEach(function() {
        instance = new MissionControl.ProductionStrategy();
      });

      it('should create an instance of ProductionStrategy', function() {
        // TODO: update the code to test ProductionStrategy
        expect(instance).to.be.a(MissionControl.ProductionStrategy);
      });
