...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DesiredSubstrateUpdate', function() {
      beforeEach(function() {
        instance = new MissionControl.DesiredSubstrateUpdate();
      });

      it('should create an instance of DesiredSubstrateUpdate', function() {
        // TODO: update the code to test DesiredSubstrateUpdate
        expect(instance).to.be.a(MissionControl.DesiredSubstrateUpdate);
      });
