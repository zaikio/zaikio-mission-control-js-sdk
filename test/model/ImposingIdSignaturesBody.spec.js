...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ImposingIdSignaturesBody', function() {
      beforeEach(function() {
        instance = new MissionControl.ImposingIdSignaturesBody();
      });

      it('should create an instance of ImposingIdSignaturesBody', function() {
        // TODO: update the code to test ImposingIdSignaturesBody
        expect(instance).to.be.a(MissionControl.ImposingIdSignaturesBody);
      });
