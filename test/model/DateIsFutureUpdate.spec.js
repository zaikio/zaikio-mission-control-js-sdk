...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DateIsFutureUpdate', function() {
      beforeEach(function() {
        instance = new MissionControl.DateIsFutureUpdate();
      });

      it('should create an instance of DateIsFutureUpdate', function() {
        // TODO: update the code to test DateIsFutureUpdate
        expect(instance).to.be.a(MissionControl.DateIsFutureUpdate);
      });
