...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PrintFreeMargins2', function() {
      beforeEach(function() {
        instance = new MissionControl.PrintFreeMargins2();
      });

      it('should create an instance of PrintFreeMargins2', function() {
        // TODO: update the code to test PrintFreeMargins2
        expect(instance).to.be.a(MissionControl.PrintFreeMargins2);
      });
