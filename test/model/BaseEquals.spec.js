...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('BaseEquals', function() {
      beforeEach(function() {
        instance = new MissionControl.BaseEquals();
      });

      it('should create an instance of BaseEquals', function() {
        // TODO: update the code to test BaseEquals
        expect(instance).to.be.a(MissionControl.BaseEquals);
      });
