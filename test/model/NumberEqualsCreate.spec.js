...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('NumberEqualsCreate', function() {
      beforeEach(function() {
        instance = new MissionControl.NumberEqualsCreate();
      });

      it('should create an instance of NumberEqualsCreate', function() {
        // TODO: update the code to test NumberEqualsCreate
        expect(instance).to.be.a(MissionControl.NumberEqualsCreate);
      });
