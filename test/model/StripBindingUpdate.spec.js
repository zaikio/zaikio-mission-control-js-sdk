...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('StripBindingUpdate', function() {
      beforeEach(function() {
        instance = new MissionControl.StripBindingUpdate();
      });

      it('should create an instance of StripBindingUpdate', function() {
        // TODO: update the code to test StripBindingUpdate
        expect(instance).to.be.a(MissionControl.StripBindingUpdate);
      });
