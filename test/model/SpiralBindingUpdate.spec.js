...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SpiralBindingUpdate', function() {
      beforeEach(function() {
        instance = new MissionControl.SpiralBindingUpdate();
      });

      it('should create an instance of SpiralBindingUpdate', function() {
        // TODO: update the code to test SpiralBindingUpdate
        expect(instance).to.be.a(MissionControl.SpiralBindingUpdate);
      });
