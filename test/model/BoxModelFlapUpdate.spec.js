...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('BoxModelFlapUpdate', function() {
      beforeEach(function() {
        instance = new MissionControl.BoxModelFlapUpdate();
      });

      it('should create an instance of BoxModelFlapUpdate', function() {
        // TODO: update the code to test BoxModelFlapUpdate
        expect(instance).to.be.a(MissionControl.BoxModelFlapUpdate);
      });
