...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ListsListIdBody', function() {
      beforeEach(function() {
        instance = new MissionControl.ListsListIdBody();
      });

      it('should create an instance of ListsListIdBody', function() {
        // TODO: update the code to test ListsListIdBody
        expect(instance).to.be.a(MissionControl.ListsListIdBody);
      });
