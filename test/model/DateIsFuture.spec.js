...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DateIsFuture', function() {
      beforeEach(function() {
        instance = new MissionControl.DateIsFuture();
      });

      it('should create an instance of DateIsFuture', function() {
        // TODO: update the code to test DateIsFuture
        expect(instance).to.be.a(MissionControl.DateIsFuture);
      });
