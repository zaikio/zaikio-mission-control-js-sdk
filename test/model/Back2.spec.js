...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Back2', function() {
      beforeEach(function() {
        instance = new MissionControl.Back2();
      });

      it('should create an instance of Back2', function() {
        // TODO: update the code to test Back2
        expect(instance).to.be.a(MissionControl.Back2);
      });
