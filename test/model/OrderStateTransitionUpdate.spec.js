...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('OrderStateTransitionUpdate', function() {
      beforeEach(function() {
        instance = new MissionControl.OrderStateTransitionUpdate();
      });

      it('should create an instance of OrderStateTransitionUpdate', function() {
        // TODO: update the code to test OrderStateTransitionUpdate
        expect(instance).to.be.a(MissionControl.OrderStateTransitionUpdate);
      });
