...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DateEqualsCreate', function() {
      beforeEach(function() {
        instance = new MissionControl.DateEqualsCreate();
      });

      it('should create an instance of DateEqualsCreate', function() {
        // TODO: update the code to test DateEqualsCreate
        expect(instance).to.be.a(MissionControl.DateEqualsCreate);
      });
