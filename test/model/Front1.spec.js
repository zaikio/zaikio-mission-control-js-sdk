...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Front1', function() {
      beforeEach(function() {
        instance = new MissionControl.Front1();
      });

      it('should create an instance of Front1', function() {
        // TODO: update the code to test Front1
        expect(instance).to.be.a(MissionControl.Front1);
      });
