...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('BoxModelPartLayout', function() {
      beforeEach(function() {
        instance = new MissionControl.BoxModelPartLayout();
      });

      it('should create an instance of BoxModelPartLayout', function() {
        // TODO: update the code to test BoxModelPartLayout
        expect(instance).to.be.a(MissionControl.BoxModelPartLayout);
      });
