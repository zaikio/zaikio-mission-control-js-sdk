...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PartsPartIdBody', function() {
      beforeEach(function() {
        instance = new MissionControl.PartsPartIdBody();
      });

      it('should create an instance of PartsPartIdBody', function() {
        // TODO: update the code to test PartsPartIdBody
        expect(instance).to.be.a(MissionControl.PartsPartIdBody);
      });
