...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ListsBody', function() {
      beforeEach(function() {
        instance = new MissionControl.ListsBody();
      });

      it('should create an instance of ListsBody', function() {
        // TODO: update the code to test ListsBody
        expect(instance).to.be.a(MissionControl.ListsBody);
      });
