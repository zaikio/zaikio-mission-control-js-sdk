...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('StringBeginsCreate', function() {
      beforeEach(function() {
        instance = new MissionControl.StringBeginsCreate();
      });

      it('should create an instance of StringBeginsCreate', function() {
        // TODO: update the code to test StringBeginsCreate
        expect(instance).to.be.a(MissionControl.StringBeginsCreate);
      });
