...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SpiralBindingCreate', function() {
      beforeEach(function() {
        instance = new MissionControl.SpiralBindingCreate();
      });

      it('should create an instance of SpiralBindingCreate', function() {
        // TODO: update the code to test SpiralBindingCreate
        expect(instance).to.be.a(MissionControl.SpiralBindingCreate);
      });
      ...
      it('should have the property hanger (base name: "hanger")', function() {
        // TODO: update the code to test the property hanger
        expect(instance).to.have.property('hanger');
        // expect(instance.hanger).to.be(expectedValueLiteral);
      });
