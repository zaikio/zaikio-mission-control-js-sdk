...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('BoxModelSignatureLayoutCreate', function() {
      beforeEach(function() {
        instance = new MissionControl.BoxModelSignatureLayoutCreate();
      });

      it('should create an instance of BoxModelSignatureLayoutCreate', function() {
        // TODO: update the code to test BoxModelSignatureLayoutCreate
        expect(instance).to.be.a(MissionControl.BoxModelSignatureLayoutCreate);
      });
