...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('FoilStampUpdate', function() {
      beforeEach(function() {
        instance = new MissionControl.FoilStampUpdate();
      });

      it('should create an instance of FoilStampUpdate', function() {
        // TODO: update the code to test FoilStampUpdate
        expect(instance).to.be.a(MissionControl.FoilStampUpdate);
      });
