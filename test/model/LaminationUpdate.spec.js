...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('LaminationUpdate', function() {
      beforeEach(function() {
        instance = new MissionControl.LaminationUpdate();
      });

      it('should create an instance of LaminationUpdate', function() {
        // TODO: update the code to test LaminationUpdate
        expect(instance).to.be.a(MissionControl.LaminationUpdate);
      });
