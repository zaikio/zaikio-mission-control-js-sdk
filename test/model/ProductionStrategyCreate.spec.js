...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ProductionStrategyCreate', function() {
      beforeEach(function() {
        instance = new MissionControl.ProductionStrategyCreate();
      });

      it('should create an instance of ProductionStrategyCreate', function() {
        // TODO: update the code to test ProductionStrategyCreate
        expect(instance).to.be.a(MissionControl.ProductionStrategyCreate);
      });
