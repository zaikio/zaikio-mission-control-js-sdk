...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ExecutionUpdate', function() {
      beforeEach(function() {
        instance = new MissionControl.ExecutionUpdate();
      });

      it('should create an instance of ExecutionUpdate', function() {
        // TODO: update the code to test ExecutionUpdate
        expect(instance).to.be.a(MissionControl.ExecutionUpdate);
      });
