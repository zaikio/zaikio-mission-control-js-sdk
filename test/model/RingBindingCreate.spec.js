...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('RingBindingCreate', function() {
      beforeEach(function() {
        instance = new MissionControl.RingBindingCreate();
      });

      it('should create an instance of RingBindingCreate', function() {
        // TODO: update the code to test RingBindingCreate
        expect(instance).to.be.a(MissionControl.RingBindingCreate);
      });
