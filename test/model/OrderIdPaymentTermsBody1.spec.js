...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('OrderIdPaymentTermsBody1', function() {
      beforeEach(function() {
        instance = new MissionControl.OrderIdPaymentTermsBody1();
      });

      it('should create an instance of OrderIdPaymentTermsBody1', function() {
        // TODO: update the code to test OrderIdPaymentTermsBody1
        expect(instance).to.be.a(MissionControl.OrderIdPaymentTermsBody1);
      });
