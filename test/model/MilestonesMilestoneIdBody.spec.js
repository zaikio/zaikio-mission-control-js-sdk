...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('MilestonesMilestoneIdBody', function() {
      beforeEach(function() {
        instance = new MissionControl.MilestonesMilestoneIdBody();
      });

      it('should create an instance of MilestonesMilestoneIdBody', function() {
        // TODO: update the code to test MilestonesMilestoneIdBody
        expect(instance).to.be.a(MissionControl.MilestonesMilestoneIdBody);
      });
