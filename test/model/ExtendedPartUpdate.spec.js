...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ExtendedPartUpdate', function() {
      beforeEach(function() {
        instance = new MissionControl.ExtendedPartUpdate();
      });

      it('should create an instance of ExtendedPartUpdate', function() {
        // TODO: update the code to test ExtendedPartUpdate
        expect(instance).to.be.a(MissionControl.ExtendedPartUpdate);
      });
