...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('NumberEquals', function() {
      beforeEach(function() {
        instance = new MissionControl.NumberEquals();
      });

      it('should create an instance of NumberEquals', function() {
        // TODO: update the code to test NumberEquals
        expect(instance).to.be.a(MissionControl.NumberEquals);
      });
