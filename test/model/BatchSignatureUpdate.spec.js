...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('BatchSignatureUpdate', function() {
      beforeEach(function() {
        instance = new MissionControl.BatchSignatureUpdate();
      });

      it('should create an instance of BatchSignatureUpdate', function() {
        // TODO: update the code to test BatchSignatureUpdate
        expect(instance).to.be.a(MissionControl.BatchSignatureUpdate);
      });
