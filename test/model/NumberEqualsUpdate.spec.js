...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('NumberEqualsUpdate', function() {
      beforeEach(function() {
        instance = new MissionControl.NumberEqualsUpdate();
      });

      it('should create an instance of NumberEqualsUpdate', function() {
        // TODO: update the code to test NumberEqualsUpdate
        expect(instance).to.be.a(MissionControl.NumberEqualsUpdate);
      });
