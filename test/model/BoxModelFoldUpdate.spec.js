...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('BoxModelFoldUpdate', function() {
      beforeEach(function() {
        instance = new MissionControl.BoxModelFoldUpdate();
      });

      it('should create an instance of BoxModelFoldUpdate', function() {
        // TODO: update the code to test BoxModelFoldUpdate
        expect(instance).to.be.a(MissionControl.BoxModelFoldUpdate);
      });
