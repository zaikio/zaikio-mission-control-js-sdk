...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('BoxModelFinishingCreate', function() {
      beforeEach(function() {
        instance = new MissionControl.BoxModelFinishingCreate();
      });

      it('should create an instance of BoxModelFinishingCreate', function() {
        // TODO: update the code to test BoxModelFinishingCreate
        expect(instance).to.be.a(MissionControl.BoxModelFinishingCreate);
      });
