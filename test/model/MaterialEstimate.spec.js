...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('MaterialEstimate', function() {
      beforeEach(function() {
        instance = new MissionControl.MaterialEstimate();
      });

      it('should create an instance of MaterialEstimate', function() {
        // TODO: update the code to test MaterialEstimate
        expect(instance).to.be.a(MissionControl.MaterialEstimate);
      });
