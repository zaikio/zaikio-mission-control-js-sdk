...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('BaseGreaterThan', function() {
      beforeEach(function() {
        instance = new MissionControl.BaseGreaterThan();
      });

      it('should create an instance of BaseGreaterThan', function() {
        // TODO: update the code to test BaseGreaterThan
        expect(instance).to.be.a(MissionControl.BaseGreaterThan);
      });
