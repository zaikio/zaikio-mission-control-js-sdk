...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('BoxModelRollSegment', function() {
      beforeEach(function() {
        instance = new MissionControl.BoxModelRollSegment();
      });

      it('should create an instance of BoxModelRollSegment', function() {
        // TODO: update the code to test BoxModelRollSegment
        expect(instance).to.be.a(MissionControl.BoxModelRollSegment);
      });
