...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PrintFreeMargins1', function() {
      beforeEach(function() {
        instance = new MissionControl.PrintFreeMargins1();
      });

      it('should create an instance of PrintFreeMargins1', function() {
        // TODO: update the code to test PrintFreeMargins1
        expect(instance).to.be.a(MissionControl.PrintFreeMargins1);
      });
