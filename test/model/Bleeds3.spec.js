...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Bleeds3', function() {
      beforeEach(function() {
        instance = new MissionControl.Bleeds3();
      });

      it('should create an instance of Bleeds3', function() {
        // TODO: update the code to test Bleeds3
        expect(instance).to.be.a(MissionControl.Bleeds3);
      });
