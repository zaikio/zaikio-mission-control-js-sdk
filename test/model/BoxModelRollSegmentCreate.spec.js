...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('BoxModelRollSegmentCreate', function() {
      beforeEach(function() {
        instance = new MissionControl.BoxModelRollSegmentCreate();
      });

      it('should create an instance of BoxModelRollSegmentCreate', function() {
        // TODO: update the code to test BoxModelRollSegmentCreate
        expect(instance).to.be.a(MissionControl.BoxModelRollSegmentCreate);
      });
