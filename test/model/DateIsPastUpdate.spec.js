...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DateIsPastUpdate', function() {
      beforeEach(function() {
        instance = new MissionControl.DateIsPastUpdate();
      });

      it('should create an instance of DateIsPastUpdate', function() {
        // TODO: update the code to test DateIsPastUpdate
        expect(instance).to.be.a(MissionControl.DateIsPastUpdate);
      });
