...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('BoxModelPageCreate', function() {
      beforeEach(function() {
        instance = new MissionControl.BoxModelPageCreate();
      });

      it('should create an instance of BoxModelPageCreate', function() {
        // TODO: update the code to test BoxModelPageCreate
        expect(instance).to.be.a(MissionControl.BoxModelPageCreate);
      });
