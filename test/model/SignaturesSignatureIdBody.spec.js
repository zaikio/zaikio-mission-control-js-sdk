...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SignaturesSignatureIdBody', function() {
      beforeEach(function() {
        instance = new MissionControl.SignaturesSignatureIdBody();
      });

      it('should create an instance of SignaturesSignatureIdBody', function() {
        // TODO: update the code to test SignaturesSignatureIdBody
        expect(instance).to.be.a(MissionControl.SignaturesSignatureIdBody);
      });
