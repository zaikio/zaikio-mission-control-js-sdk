...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('StringEquals', function() {
      beforeEach(function() {
        instance = new MissionControl.StringEquals();
      });

      it('should create an instance of StringEquals', function() {
        // TODO: update the code to test StringEquals
        expect(instance).to.be.a(MissionControl.StringEquals);
      });
