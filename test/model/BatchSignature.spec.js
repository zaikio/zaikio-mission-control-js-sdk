...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('BatchSignature', function() {
      beforeEach(function() {
        instance = new MissionControl.BatchSignature();
      });

      it('should create an instance of BatchSignature', function() {
        // TODO: update the code to test BatchSignature
        expect(instance).to.be.a(MissionControl.BatchSignature);
      });
