...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('NumberLessThan', function() {
      beforeEach(function() {
        instance = new MissionControl.NumberLessThan();
      });

      it('should create an instance of NumberLessThan', function() {
        // TODO: update the code to test NumberLessThan
        expect(instance).to.be.a(MissionControl.NumberLessThan);
      });
