...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DateIsToday', function() {
      beforeEach(function() {
        instance = new MissionControl.DateIsToday();
      });

      it('should create an instance of DateIsToday', function() {
        // TODO: update the code to test DateIsToday
        expect(instance).to.be.a(MissionControl.DateIsToday);
      });
