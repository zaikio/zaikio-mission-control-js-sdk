...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('StringContainsUpdate', function() {
      beforeEach(function() {
        instance = new MissionControl.StringContainsUpdate();
      });

      it('should create an instance of StringContainsUpdate', function() {
        // TODO: update the code to test StringContainsUpdate
        expect(instance).to.be.a(MissionControl.StringContainsUpdate);
      });
