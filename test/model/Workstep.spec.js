...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Workstep', function() {
      beforeEach(function() {
        instance = new MissionControl.Workstep();
      });

      it('should create an instance of Workstep', function() {
        // TODO: update the code to test Workstep
        expect(instance).to.be.a(MissionControl.Workstep);
      });
      ...
      it('should have the property expectedTotalCosts (base name: "expected_total_costs")', function() {
        // TODO: update the code to test the property expectedTotalCosts
        expect(instance).to.have.property('expectedTotalCosts');
        // expect(instance.expectedTotalCosts).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property expectedTotalDuration (base name: "expected_total_duration")', function() {
        // TODO: update the code to test the property expectedTotalDuration
        expect(instance).to.have.property('expectedTotalDuration');
        // expect(instance.expectedTotalDuration).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property actualTotalCosts (base name: "actual_total_costs")', function() {
        // TODO: update the code to test the property actualTotalCosts
        expect(instance).to.have.property('actualTotalCosts');
        // expect(instance.actualTotalCosts).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property actualTotalDuration (base name: "actual_total_duration")', function() {
        // TODO: update the code to test the property actualTotalDuration
        expect(instance).to.have.property('actualTotalDuration');
        // expect(instance.actualTotalDuration).to.be(expectedValueLiteral);
      });
