...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('StringEnds', function() {
      beforeEach(function() {
        instance = new MissionControl.StringEnds();
      });

      it('should create an instance of StringEnds', function() {
        // TODO: update the code to test StringEnds
        expect(instance).to.be.a(MissionControl.StringEnds);
      });
