...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('BoxModelMark', function() {
      beforeEach(function() {
        instance = new MissionControl.BoxModelMark();
      });

      it('should create an instance of BoxModelMark', function() {
        // TODO: update the code to test BoxModelMark
        expect(instance).to.be.a(MissionControl.BoxModelMark);
      });
