...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Embossing', function() {
      beforeEach(function() {
        instance = new MissionControl.Embossing();
      });

      it('should create an instance of Embossing', function() {
        // TODO: update the code to test Embossing
        expect(instance).to.be.a(MissionControl.Embossing);
      });
