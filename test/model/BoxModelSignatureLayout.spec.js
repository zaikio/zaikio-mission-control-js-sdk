...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('BoxModelSignatureLayout', function() {
      beforeEach(function() {
        instance = new MissionControl.BoxModelSignatureLayout();
      });

      it('should create an instance of BoxModelSignatureLayout', function() {
        // TODO: update the code to test BoxModelSignatureLayout
        expect(instance).to.be.a(MissionControl.BoxModelSignatureLayout);
      });
