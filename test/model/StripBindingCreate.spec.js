...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('StripBindingCreate', function() {
      beforeEach(function() {
        instance = new MissionControl.StripBindingCreate();
      });

      it('should create an instance of StripBindingCreate', function() {
        // TODO: update the code to test StripBindingCreate
        expect(instance).to.be.a(MissionControl.StripBindingCreate);
      });
      ...
      it('should have the property pinHeight (base name: "pin_height")', function() {
        // TODO: update the code to test the property pinHeight
        expect(instance).to.have.property('pinHeight');
        // expect(instance.pinHeight).to.be(expectedValueLiteral);
      });
