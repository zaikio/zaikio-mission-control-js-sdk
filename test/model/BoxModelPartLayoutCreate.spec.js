...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('BoxModelPartLayoutCreate', function() {
      beforeEach(function() {
        instance = new MissionControl.BoxModelPartLayoutCreate();
      });

      it('should create an instance of BoxModelPartLayoutCreate', function() {
        // TODO: update the code to test BoxModelPartLayoutCreate
        expect(instance).to.be.a(MissionControl.BoxModelPartLayoutCreate);
      });
