...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('BoxModelSheet', function() {
      beforeEach(function() {
        instance = new MissionControl.BoxModelSheet();
      });

      it('should create an instance of BoxModelSheet', function() {
        // TODO: update the code to test BoxModelSheet
        expect(instance).to.be.a(MissionControl.BoxModelSheet);
      });
