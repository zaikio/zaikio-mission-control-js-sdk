...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DateEqualsUpdate', function() {
      beforeEach(function() {
        instance = new MissionControl.DateEqualsUpdate();
      });

      it('should create an instance of DateEqualsUpdate', function() {
        // TODO: update the code to test DateEqualsUpdate
        expect(instance).to.be.a(MissionControl.DateEqualsUpdate);
      });
