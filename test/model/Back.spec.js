...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Back', function() {
      beforeEach(function() {
        instance = new MissionControl.Back();
      });

      it('should create an instance of Back', function() {
        // TODO: update the code to test Back
        expect(instance).to.be.a(MissionControl.Back);
      });
