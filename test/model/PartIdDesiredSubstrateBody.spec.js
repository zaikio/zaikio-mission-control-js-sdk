...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PartIdDesiredSubstrateBody', function() {
      beforeEach(function() {
        instance = new MissionControl.PartIdDesiredSubstrateBody();
      });

      it('should create an instance of PartIdDesiredSubstrateBody', function() {
        // TODO: update the code to test PartIdDesiredSubstrateBody
        expect(instance).to.be.a(MissionControl.PartIdDesiredSubstrateBody);
      });
