...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SignatureCreate', function() {
      beforeEach(function() {
        instance = new MissionControl.SignatureCreate();
      });

      it('should create an instance of SignatureCreate', function() {
        // TODO: update the code to test SignatureCreate
        expect(instance).to.be.a(MissionControl.SignatureCreate);
      });
