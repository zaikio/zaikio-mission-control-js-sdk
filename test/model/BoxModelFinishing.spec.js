...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('BoxModelFinishing', function() {
      beforeEach(function() {
        instance = new MissionControl.BoxModelFinishing();
      });

      it('should create an instance of BoxModelFinishing', function() {
        // TODO: update the code to test BoxModelFinishing
        expect(instance).to.be.a(MissionControl.BoxModelFinishing);
      });
