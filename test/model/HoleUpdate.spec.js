...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('HoleUpdate', function() {
      beforeEach(function() {
        instance = new MissionControl.HoleUpdate();
      });

      it('should create an instance of HoleUpdate', function() {
        // TODO: update the code to test HoleUpdate
        expect(instance).to.be.a(MissionControl.HoleUpdate);
      });
      ...
      it('should have the property grommet (base name: "grommet")', function() {
        // TODO: update the code to test the property grommet
        expect(instance).to.have.property('grommet');
        // expect(instance.grommet).to.be(expectedValueLiteral);
      });
