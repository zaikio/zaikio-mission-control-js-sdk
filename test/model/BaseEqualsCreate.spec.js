...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('BaseEqualsCreate', function() {
      beforeEach(function() {
        instance = new MissionControl.BaseEqualsCreate();
      });

      it('should create an instance of BaseEqualsCreate', function() {
        // TODO: update the code to test BaseEqualsCreate
        expect(instance).to.be.a(MissionControl.BaseEqualsCreate);
      });
