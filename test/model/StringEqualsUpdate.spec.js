...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('StringEqualsUpdate', function() {
      beforeEach(function() {
        instance = new MissionControl.StringEqualsUpdate();
      });

      it('should create an instance of StringEqualsUpdate', function() {
        // TODO: update the code to test StringEqualsUpdate
        expect(instance).to.be.a(MissionControl.StringEqualsUpdate);
      });
