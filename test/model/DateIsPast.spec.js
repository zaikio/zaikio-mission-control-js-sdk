...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DateIsPast', function() {
      beforeEach(function() {
        instance = new MissionControl.DateIsPast();
      });

      it('should create an instance of DateIsPast', function() {
        // TODO: update the code to test DateIsPast
        expect(instance).to.be.a(MissionControl.DateIsPast);
      });
