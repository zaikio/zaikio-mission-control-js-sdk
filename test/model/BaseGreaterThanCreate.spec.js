...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('BaseGreaterThanCreate', function() {
      beforeEach(function() {
        instance = new MissionControl.BaseGreaterThanCreate();
      });

      it('should create an instance of BaseGreaterThanCreate', function() {
        // TODO: update the code to test BaseGreaterThanCreate
        expect(instance).to.be.a(MissionControl.BaseGreaterThanCreate);
      });
