...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('NumberLessThanUpdate', function() {
      beforeEach(function() {
        instance = new MissionControl.NumberLessThanUpdate();
      });

      it('should create an instance of NumberLessThanUpdate', function() {
        // TODO: update the code to test NumberLessThanUpdate
        expect(instance).to.be.a(MissionControl.NumberLessThanUpdate);
      });
