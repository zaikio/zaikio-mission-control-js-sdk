...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('StringBegins', function() {
      beforeEach(function() {
        instance = new MissionControl.StringBegins();
      });

      it('should create an instance of StringBegins', function() {
        // TODO: update the code to test StringBegins
        expect(instance).to.be.a(MissionControl.StringBegins);
      });
