...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Hole', function() {
      beforeEach(function() {
        instance = new MissionControl.Hole();
      });

      it('should create an instance of Hole', function() {
        // TODO: update the code to test Hole
        expect(instance).to.be.a(MissionControl.Hole);
      });
