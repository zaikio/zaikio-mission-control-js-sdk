...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CombBindingCreate', function() {
      beforeEach(function() {
        instance = new MissionControl.CombBindingCreate();
      });

      it('should create an instance of CombBindingCreate', function() {
        // TODO: update the code to test CombBindingCreate
        expect(instance).to.be.a(MissionControl.CombBindingCreate);
      });
