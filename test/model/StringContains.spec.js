...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('StringContains', function() {
      beforeEach(function() {
        instance = new MissionControl.StringContains();
      });

      it('should create an instance of StringContains', function() {
        // TODO: update the code to test StringContains
        expect(instance).to.be.a(MissionControl.StringContains);
      });
