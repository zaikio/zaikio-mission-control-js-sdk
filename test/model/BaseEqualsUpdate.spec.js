...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('BaseEqualsUpdate', function() {
      beforeEach(function() {
        instance = new MissionControl.BaseEqualsUpdate();
      });

      it('should create an instance of BaseEqualsUpdate', function() {
        // TODO: update the code to test BaseEqualsUpdate
        expect(instance).to.be.a(MissionControl.BaseEqualsUpdate);
      });
