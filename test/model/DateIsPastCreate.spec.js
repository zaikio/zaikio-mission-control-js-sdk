...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DateIsPastCreate', function() {
      beforeEach(function() {
        instance = new MissionControl.DateIsPastCreate();
      });

      it('should create an instance of DateIsPastCreate', function() {
        // TODO: update the code to test DateIsPastCreate
        expect(instance).to.be.a(MissionControl.DateIsPastCreate);
      });
