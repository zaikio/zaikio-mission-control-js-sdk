...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('BoxModelFold', function() {
      beforeEach(function() {
        instance = new MissionControl.BoxModelFold();
      });

      it('should create an instance of BoxModelFold', function() {
        // TODO: update the code to test BoxModelFold
        expect(instance).to.be.a(MissionControl.BoxModelFold);
      });
