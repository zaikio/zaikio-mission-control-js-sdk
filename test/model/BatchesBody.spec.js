...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('BatchesBody', function() {
      beforeEach(function() {
        instance = new MissionControl.BatchesBody();
      });

      it('should create an instance of BatchesBody', function() {
        // TODO: update the code to test BatchesBody
        expect(instance).to.be.a(MissionControl.BatchesBody);
      });
