...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('RingBinding', function() {
      beforeEach(function() {
        instance = new MissionControl.RingBinding();
      });

      it('should create an instance of RingBinding', function() {
        // TODO: update the code to test RingBinding
        expect(instance).to.be.a(MissionControl.RingBinding);
      });
