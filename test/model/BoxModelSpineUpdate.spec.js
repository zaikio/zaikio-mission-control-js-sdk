...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('BoxModelSpineUpdate', function() {
      beforeEach(function() {
        instance = new MissionControl.BoxModelSpineUpdate();
      });

      it('should create an instance of BoxModelSpineUpdate', function() {
        // TODO: update the code to test BoxModelSpineUpdate
        expect(instance).to.be.a(MissionControl.BoxModelSpineUpdate);
      });
