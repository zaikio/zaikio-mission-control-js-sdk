...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PartCreate', function() {
      beforeEach(function() {
        instance = new MissionControl.PartCreate();
      });

      it('should create an instance of PartCreate', function() {
        // TODO: update the code to test PartCreate
        expect(instance).to.be.a(MissionControl.PartCreate);
      });
