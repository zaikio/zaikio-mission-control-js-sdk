...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('JobIdFinishedProductBody', function() {
      beforeEach(function() {
        instance = new MissionControl.JobIdFinishedProductBody();
      });

      it('should create an instance of JobIdFinishedProductBody', function() {
        // TODO: update the code to test JobIdFinishedProductBody
        expect(instance).to.be.a(MissionControl.JobIdFinishedProductBody);
      });
