...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('JobIdMilestonesBody', function() {
      beforeEach(function() {
        instance = new MissionControl.JobIdMilestonesBody();
      });

      it('should create an instance of JobIdMilestonesBody', function() {
        // TODO: update the code to test JobIdMilestonesBody
        expect(instance).to.be.a(MissionControl.JobIdMilestonesBody);
      });
