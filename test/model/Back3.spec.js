...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Back3', function() {
      beforeEach(function() {
        instance = new MissionControl.Back3();
      });

      it('should create an instance of Back3', function() {
        // TODO: update the code to test Back3
        expect(instance).to.be.a(MissionControl.Back3);
      });
