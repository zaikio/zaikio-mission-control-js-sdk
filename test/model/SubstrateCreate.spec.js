...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SubstrateCreate', function() {
      beforeEach(function() {
        instance = new MissionControl.SubstrateCreate();
      });

      it('should create an instance of SubstrateCreate', function() {
        // TODO: update the code to test SubstrateCreate
        expect(instance).to.be.a(MissionControl.SubstrateCreate);
      });
