...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('RingBindingUpdate', function() {
      beforeEach(function() {
        instance = new MissionControl.RingBindingUpdate();
      });

      it('should create an instance of RingBindingUpdate', function() {
        // TODO: update the code to test RingBindingUpdate
        expect(instance).to.be.a(MissionControl.RingBindingUpdate);
      });
