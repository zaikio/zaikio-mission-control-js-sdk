...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Lamination', function() {
      beforeEach(function() {
        instance = new MissionControl.Lamination();
      });

      it('should create an instance of Lamination', function() {
        // TODO: update the code to test Lamination
        expect(instance).to.be.a(MissionControl.Lamination);
      });
