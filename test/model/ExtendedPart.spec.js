...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ExtendedPart', function() {
      beforeEach(function() {
        instance = new MissionControl.ExtendedPart();
      });

      it('should create an instance of ExtendedPart', function() {
        // TODO: update the code to test ExtendedPart
        expect(instance).to.be.a(MissionControl.ExtendedPart);
      });
