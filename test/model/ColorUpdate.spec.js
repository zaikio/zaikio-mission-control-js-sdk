...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ColorUpdate', function() {
      beforeEach(function() {
        instance = new MissionControl.ColorUpdate();
      });

      it('should create an instance of ColorUpdate', function() {
        // TODO: update the code to test ColorUpdate
        expect(instance).to.be.a(MissionControl.ColorUpdate);
      });
