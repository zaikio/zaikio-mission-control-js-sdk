...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TodoUpdate', function() {
      beforeEach(function() {
        instance = new MissionControl.TodoUpdate();
      });

      it('should create an instance of TodoUpdate', function() {
        // TODO: update the code to test TodoUpdate
        expect(instance).to.be.a(MissionControl.TodoUpdate);
      });
