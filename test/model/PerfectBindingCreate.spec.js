...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PerfectBindingCreate', function() {
      beforeEach(function() {
        instance = new MissionControl.PerfectBindingCreate();
      });

      it('should create an instance of PerfectBindingCreate', function() {
        // TODO: update the code to test PerfectBindingCreate
        expect(instance).to.be.a(MissionControl.PerfectBindingCreate);
      });
