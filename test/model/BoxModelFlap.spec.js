...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('BoxModelFlap', function() {
      beforeEach(function() {
        instance = new MissionControl.BoxModelFlap();
      });

      it('should create an instance of BoxModelFlap', function() {
        // TODO: update the code to test BoxModelFlap
        expect(instance).to.be.a(MissionControl.BoxModelFlap);
      });
