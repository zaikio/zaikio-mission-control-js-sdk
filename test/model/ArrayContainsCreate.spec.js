...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ArrayContainsCreate', function() {
      beforeEach(function() {
        instance = new MissionControl.ArrayContainsCreate();
      });

      it('should create an instance of ArrayContainsCreate', function() {
        // TODO: update the code to test ArrayContainsCreate
        expect(instance).to.be.a(MissionControl.ArrayContainsCreate);
      });
