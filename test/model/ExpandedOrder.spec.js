...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ExpandedOrder', function() {
      beforeEach(function() {
        instance = new MissionControl.ExpandedOrder();
      });

      it('should create an instance of ExpandedOrder', function() {
        // TODO: update the code to test ExpandedOrder
        expect(instance).to.be.a(MissionControl.ExpandedOrder);
      });
