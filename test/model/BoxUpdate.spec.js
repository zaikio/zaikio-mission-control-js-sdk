...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('BoxUpdate', function() {
      beforeEach(function() {
        instance = new MissionControl.BoxUpdate();
      });

      it('should create an instance of BoxUpdate', function() {
        // TODO: update the code to test BoxUpdate
        expect(instance).to.be.a(MissionControl.BoxUpdate);
      });
      ...
      it('should have the property pageNumbers (base name: "page_numbers")', function() {
        // TODO: update the code to test the property pageNumbers
        expect(instance).to.have.property('pageNumbers');
        // expect(instance.pageNumbers).to.be(expectedValueLiteral);
      });
