...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DateIsFutureCreate', function() {
      beforeEach(function() {
        instance = new MissionControl.DateIsFutureCreate();
      });

      it('should create an instance of DateIsFutureCreate', function() {
        // TODO: update the code to test DateIsFutureCreate
        expect(instance).to.be.a(MissionControl.DateIsFutureCreate);
      });
