...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GlueUpdate', function() {
      beforeEach(function() {
        instance = new MissionControl.GlueUpdate();
      });

      it('should create an instance of GlueUpdate', function() {
        // TODO: update the code to test GlueUpdate
        expect(instance).to.be.a(MissionControl.GlueUpdate);
      });
