...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ExtendedPartCreate', function() {
      beforeEach(function() {
        instance = new MissionControl.ExtendedPartCreate();
      });

      it('should create an instance of ExtendedPartCreate', function() {
        // TODO: update the code to test ExtendedPartCreate
        expect(instance).to.be.a(MissionControl.ExtendedPartCreate);
      });
