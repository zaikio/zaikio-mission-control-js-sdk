...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('EstimatesEstimateIdBody', function() {
      beforeEach(function() {
        instance = new MissionControl.EstimatesEstimateIdBody();
      });

      it('should create an instance of EstimatesEstimateIdBody', function() {
        // TODO: update the code to test EstimatesEstimateIdBody
        expect(instance).to.be.a(MissionControl.EstimatesEstimateIdBody);
      });
