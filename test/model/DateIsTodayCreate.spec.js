...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DateIsTodayCreate', function() {
      beforeEach(function() {
        instance = new MissionControl.DateIsTodayCreate();
      });

      it('should create an instance of DateIsTodayCreate', function() {
        // TODO: update the code to test DateIsTodayCreate
        expect(instance).to.be.a(MissionControl.DateIsTodayCreate);
      });
