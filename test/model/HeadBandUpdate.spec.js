...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('HeadBandUpdate', function() {
      beforeEach(function() {
        instance = new MissionControl.HeadBandUpdate();
      });

      it('should create an instance of HeadBandUpdate', function() {
        // TODO: update the code to test HeadBandUpdate
        expect(instance).to.be.a(MissionControl.HeadBandUpdate);
      });
