...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PerforationUpdate', function() {
      beforeEach(function() {
        instance = new MissionControl.PerforationUpdate();
      });

      it('should create an instance of PerforationUpdate', function() {
        // TODO: update the code to test PerforationUpdate
        expect(instance).to.be.a(MissionControl.PerforationUpdate);
      });
