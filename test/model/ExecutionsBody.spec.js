...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ExecutionsBody', function() {
      beforeEach(function() {
        instance = new MissionControl.ExecutionsBody();
      });

      it('should create an instance of ExecutionsBody', function() {
        // TODO: update the code to test ExecutionsBody
        expect(instance).to.be.a(MissionControl.ExecutionsBody);
      });
