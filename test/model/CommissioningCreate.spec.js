...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CommissioningCreate', function() {
      beforeEach(function() {
        instance = new MissionControl.CommissioningCreate();
      });

      it('should create an instance of CommissioningCreate', function() {
        // TODO: update the code to test CommissioningCreate
        expect(instance).to.be.a(MissionControl.CommissioningCreate);
      });
