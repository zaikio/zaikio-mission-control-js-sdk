...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('BoxModelSheetUpdate', function() {
      beforeEach(function() {
        instance = new MissionControl.BoxModelSheetUpdate();
      });

      it('should create an instance of BoxModelSheetUpdate', function() {
        // TODO: update the code to test BoxModelSheetUpdate
        expect(instance).to.be.a(MissionControl.BoxModelSheetUpdate);
      });
