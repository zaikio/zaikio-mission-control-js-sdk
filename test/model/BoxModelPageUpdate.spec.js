...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('BoxModelPageUpdate', function() {
      beforeEach(function() {
        instance = new MissionControl.BoxModelPageUpdate();
      });

      it('should create an instance of BoxModelPageUpdate', function() {
        // TODO: update the code to test BoxModelPageUpdate
        expect(instance).to.be.a(MissionControl.BoxModelPageUpdate);
      });
