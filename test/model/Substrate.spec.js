...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Substrate', function() {
      beforeEach(function() {
        instance = new MissionControl.Substrate();
      });

      it('should create an instance of Substrate', function() {
        // TODO: update the code to test Substrate
        expect(instance).to.be.a(MissionControl.Substrate);
      });
