...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SpiralBinding', function() {
      beforeEach(function() {
        instance = new MissionControl.SpiralBinding();
      });

      it('should create an instance of SpiralBinding', function() {
        // TODO: update the code to test SpiralBinding
        expect(instance).to.be.a(MissionControl.SpiralBinding);
      });
