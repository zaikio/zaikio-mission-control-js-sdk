...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DateLessThan', function() {
      beforeEach(function() {
        instance = new MissionControl.DateLessThan();
      });

      it('should create an instance of DateLessThan', function() {
        // TODO: update the code to test DateLessThan
        expect(instance).to.be.a(MissionControl.DateLessThan);
      });
