...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GlueCreate', function() {
      beforeEach(function() {
        instance = new MissionControl.GlueCreate();
      });

      it('should create an instance of GlueCreate', function() {
        // TODO: update the code to test GlueCreate
        expect(instance).to.be.a(MissionControl.GlueCreate);
      });
