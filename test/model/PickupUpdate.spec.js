...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PickupUpdate', function() {
      beforeEach(function() {
        instance = new MissionControl.PickupUpdate();
      });

      it('should create an instance of PickupUpdate', function() {
        // TODO: update the code to test PickupUpdate
        expect(instance).to.be.a(MissionControl.PickupUpdate);
      });
