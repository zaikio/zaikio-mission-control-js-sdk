...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('OrderStateTransitionCreate', function() {
      beforeEach(function() {
        instance = new MissionControl.OrderStateTransitionCreate();
      });

      it('should create an instance of OrderStateTransitionCreate', function() {
        // TODO: update the code to test OrderStateTransitionCreate
        expect(instance).to.be.a(MissionControl.OrderStateTransitionCreate);
      });
