...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('LayoutCreate', function() {
      beforeEach(function() {
        instance = new MissionControl.LayoutCreate();
      });

      it('should create an instance of LayoutCreate', function() {
        // TODO: update the code to test LayoutCreate
        expect(instance).to.be.a(MissionControl.LayoutCreate);
      });
