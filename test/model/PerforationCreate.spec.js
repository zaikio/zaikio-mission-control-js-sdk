...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PerforationCreate', function() {
      beforeEach(function() {
        instance = new MissionControl.PerforationCreate();
      });

      it('should create an instance of PerforationCreate', function() {
        // TODO: update the code to test PerforationCreate
        expect(instance).to.be.a(MissionControl.PerforationCreate);
      });
      ...
      it('should have the property teeth (base name: "teeth")', function() {
        // TODO: update the code to test the property teeth
        expect(instance).to.have.property('teeth');
        // expect(instance.teeth).to.be(expectedValueLiteral);
      });
