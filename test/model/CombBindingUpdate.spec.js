...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CombBindingUpdate', function() {
      beforeEach(function() {
        instance = new MissionControl.CombBindingUpdate();
      });

      it('should create an instance of CombBindingUpdate', function() {
        // TODO: update the code to test CombBindingUpdate
        expect(instance).to.be.a(MissionControl.CombBindingUpdate);
      });
