...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('MaterialEstimateCreate', function() {
      beforeEach(function() {
        instance = new MissionControl.MaterialEstimateCreate();
      });

      it('should create an instance of MaterialEstimateCreate', function() {
        // TODO: update the code to test MaterialEstimateCreate
        expect(instance).to.be.a(MissionControl.MaterialEstimateCreate);
      });
