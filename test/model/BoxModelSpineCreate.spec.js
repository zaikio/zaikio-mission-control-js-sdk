...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('BoxModelSpineCreate', function() {
      beforeEach(function() {
        instance = new MissionControl.BoxModelSpineCreate();
      });

      it('should create an instance of BoxModelSpineCreate', function() {
        // TODO: update the code to test BoxModelSpineCreate
        expect(instance).to.be.a(MissionControl.BoxModelSpineCreate);
      });
