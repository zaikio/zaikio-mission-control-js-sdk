...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ExpandedOrderUpdate', function() {
      beforeEach(function() {
        instance = new MissionControl.ExpandedOrderUpdate();
      });

      it('should create an instance of ExpandedOrderUpdate', function() {
        // TODO: update the code to test ExpandedOrderUpdate
        expect(instance).to.be.a(MissionControl.ExpandedOrderUpdate);
      });
