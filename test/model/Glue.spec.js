...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Glue', function() {
      beforeEach(function() {
        instance = new MissionControl.Glue();
      });

      it('should create an instance of Glue', function() {
        // TODO: update the code to test Glue
        expect(instance).to.be.a(MissionControl.Glue);
      });
