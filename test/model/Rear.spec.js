...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Rear', function() {
      beforeEach(function() {
        instance = new MissionControl.Rear();
      });

      it('should create an instance of Rear', function() {
        // TODO: update the code to test Rear
        expect(instance).to.be.a(MissionControl.Rear);
      });
