...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('StringContainsCreate', function() {
      beforeEach(function() {
        instance = new MissionControl.StringContainsCreate();
      });

      it('should create an instance of StringContainsCreate', function() {
        // TODO: update the code to test StringContainsCreate
        expect(instance).to.be.a(MissionControl.StringContainsCreate);
      });
