...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('BoxModelPage', function() {
      beforeEach(function() {
        instance = new MissionControl.BoxModelPage();
      });

      it('should create an instance of BoxModelPage', function() {
        // TODO: update the code to test BoxModelPage
        expect(instance).to.be.a(MissionControl.BoxModelPage);
      });
