...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('BoxModelFinishingUpdate', function() {
      beforeEach(function() {
        instance = new MissionControl.BoxModelFinishingUpdate();
      });

      it('should create an instance of BoxModelFinishingUpdate', function() {
        // TODO: update the code to test BoxModelFinishingUpdate
        expect(instance).to.be.a(MissionControl.BoxModelFinishingUpdate);
      });
