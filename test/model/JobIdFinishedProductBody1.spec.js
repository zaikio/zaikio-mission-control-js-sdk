...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('JobIdFinishedProductBody1', function() {
      beforeEach(function() {
        instance = new MissionControl.JobIdFinishedProductBody1();
      });

      it('should create an instance of JobIdFinishedProductBody1', function() {
        // TODO: update the code to test JobIdFinishedProductBody1
        expect(instance).to.be.a(MissionControl.JobIdFinishedProductBody1);
      });
