...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DateLessThanUpdate', function() {
      beforeEach(function() {
        instance = new MissionControl.DateLessThanUpdate();
      });

      it('should create an instance of DateLessThanUpdate', function() {
        // TODO: update the code to test DateLessThanUpdate
        expect(instance).to.be.a(MissionControl.DateLessThanUpdate);
      });
