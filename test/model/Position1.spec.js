...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Position1', function() {
      beforeEach(function() {
        instance = new MissionControl.Position1();
      });

      it('should create an instance of Position1', function() {
        // TODO: update the code to test Position1
        expect(instance).to.be.a(MissionControl.Position1);
      });
