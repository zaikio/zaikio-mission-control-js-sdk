...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('EmbossingCreate', function() {
      beforeEach(function() {
        instance = new MissionControl.EmbossingCreate();
      });

      it('should create an instance of EmbossingCreate', function() {
        // TODO: update the code to test EmbossingCreate
        expect(instance).to.be.a(MissionControl.EmbossingCreate);
      });
