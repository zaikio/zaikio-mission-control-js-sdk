...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('OrdersBody', function() {
      beforeEach(function() {
        instance = new MissionControl.OrdersBody();
      });

      it('should create an instance of OrdersBody', function() {
        // TODO: update the code to test OrdersBody
        expect(instance).to.be.a(MissionControl.OrdersBody);
      });
