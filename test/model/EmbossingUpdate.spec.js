...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('EmbossingUpdate', function() {
      beforeEach(function() {
        instance = new MissionControl.EmbossingUpdate();
      });

      it('should create an instance of EmbossingUpdate', function() {
        // TODO: update the code to test EmbossingUpdate
        expect(instance).to.be.a(MissionControl.EmbossingUpdate);
      });
