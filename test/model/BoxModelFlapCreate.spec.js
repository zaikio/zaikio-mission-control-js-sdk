...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('BoxModelFlapCreate', function() {
      beforeEach(function() {
        instance = new MissionControl.BoxModelFlapCreate();
      });

      it('should create an instance of BoxModelFlapCreate', function() {
        // TODO: update the code to test BoxModelFlapCreate
        expect(instance).to.be.a(MissionControl.BoxModelFlapCreate);
      });
