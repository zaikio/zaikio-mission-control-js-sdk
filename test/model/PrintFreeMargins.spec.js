...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PrintFreeMargins', function() {
      beforeEach(function() {
        instance = new MissionControl.PrintFreeMargins();
      });

      it('should create an instance of PrintFreeMargins', function() {
        // TODO: update the code to test PrintFreeMargins
        expect(instance).to.be.a(MissionControl.PrintFreeMargins);
      });
