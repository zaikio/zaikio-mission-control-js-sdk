...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ThreadSewingCreate', function() {
      beforeEach(function() {
        instance = new MissionControl.ThreadSewingCreate();
      });

      it('should create an instance of ThreadSewingCreate', function() {
        // TODO: update the code to test ThreadSewingCreate
        expect(instance).to.be.a(MissionControl.ThreadSewingCreate);
      });
