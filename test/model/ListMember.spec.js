...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ListMember', function() {
      beforeEach(function() {
        instance = new MissionControl.ListMember();
      });

      it('should create an instance of ListMember', function() {
        // TODO: update the code to test ListMember
        expect(instance).to.be.a(MissionControl.ListMember);
      });
