...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ExpandedOrderCreate', function() {
      beforeEach(function() {
        instance = new MissionControl.ExpandedOrderCreate();
      });

      it('should create an instance of ExpandedOrderCreate', function() {
        // TODO: update the code to test ExpandedOrderCreate
        expect(instance).to.be.a(MissionControl.ExpandedOrderCreate);
      });
