...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CombBinding', function() {
      beforeEach(function() {
        instance = new MissionControl.CombBinding();
      });

      it('should create an instance of CombBinding', function() {
        // TODO: update the code to test CombBinding
        expect(instance).to.be.a(MissionControl.CombBinding);
      });
