...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('JobIdPartsBody', function() {
      beforeEach(function() {
        instance = new MissionControl.JobIdPartsBody();
      });

      it('should create an instance of JobIdPartsBody', function() {
        // TODO: update the code to test JobIdPartsBody
        expect(instance).to.be.a(MissionControl.JobIdPartsBody);
      });
