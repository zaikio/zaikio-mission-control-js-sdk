...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PartIdDesiredSubstrateBody1', function() {
      beforeEach(function() {
        instance = new MissionControl.PartIdDesiredSubstrateBody1();
      });

      it('should create an instance of PartIdDesiredSubstrateBody1', function() {
        // TODO: update the code to test PartIdDesiredSubstrateBody1
        expect(instance).to.be.a(MissionControl.PartIdDesiredSubstrateBody1);
      });
