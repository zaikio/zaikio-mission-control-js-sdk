...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('JobsBody', function() {
      beforeEach(function() {
        instance = new MissionControl.JobsBody();
      });

      it('should create an instance of JobsBody', function() {
        // TODO: update the code to test JobsBody
        expect(instance).to.be.a(MissionControl.JobsBody);
      });
