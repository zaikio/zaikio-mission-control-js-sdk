...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PickupsPickupIdBody', function() {
      beforeEach(function() {
        instance = new MissionControl.PickupsPickupIdBody();
      });

      it('should create an instance of PickupsPickupIdBody', function() {
        // TODO: update the code to test PickupsPickupIdBody
        expect(instance).to.be.a(MissionControl.PickupsPickupIdBody);
      });
