...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('BaseGreaterThanUpdate', function() {
      beforeEach(function() {
        instance = new MissionControl.BaseGreaterThanUpdate();
      });

      it('should create an instance of BaseGreaterThanUpdate', function() {
        // TODO: update the code to test BaseGreaterThanUpdate
        expect(instance).to.be.a(MissionControl.BaseGreaterThanUpdate);
      });
