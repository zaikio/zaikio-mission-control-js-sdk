...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Bleeds2', function() {
      beforeEach(function() {
        instance = new MissionControl.Bleeds2();
      });

      it('should create an instance of Bleeds2', function() {
        // TODO: update the code to test Bleeds2
        expect(instance).to.be.a(MissionControl.Bleeds2);
      });
