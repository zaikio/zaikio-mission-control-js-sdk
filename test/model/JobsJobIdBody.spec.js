...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('JobsJobIdBody', function() {
      beforeEach(function() {
        instance = new MissionControl.JobsJobIdBody();
      });

      it('should create an instance of JobsJobIdBody', function() {
        // TODO: update the code to test JobsJobIdBody
        expect(instance).to.be.a(MissionControl.JobsJobIdBody);
      });
