...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('BoxModelSpreadCreate', function() {
      beforeEach(function() {
        instance = new MissionControl.BoxModelSpreadCreate();
      });

      it('should create an instance of BoxModelSpreadCreate', function() {
        // TODO: update the code to test BoxModelSpreadCreate
        expect(instance).to.be.a(MissionControl.BoxModelSpreadCreate);
      });
