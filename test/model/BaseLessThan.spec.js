...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('BaseLessThan', function() {
      beforeEach(function() {
        instance = new MissionControl.BaseLessThan();
      });

      it('should create an instance of BaseLessThan', function() {
        // TODO: update the code to test BaseLessThan
        expect(instance).to.be.a(MissionControl.BaseLessThan);
      });
