...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('BoxCreate', function() {
      beforeEach(function() {
        instance = new MissionControl.BoxCreate();
      });

      it('should create an instance of BoxCreate', function() {
        // TODO: update the code to test BoxCreate
        expect(instance).to.be.a(MissionControl.BoxCreate);
      });
