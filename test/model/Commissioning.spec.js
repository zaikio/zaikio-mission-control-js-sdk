...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Commissioning', function() {
      beforeEach(function() {
        instance = new MissionControl.Commissioning();
      });

      it('should create an instance of Commissioning', function() {
        // TODO: update the code to test Commissioning
        expect(instance).to.be.a(MissionControl.Commissioning);
      });
