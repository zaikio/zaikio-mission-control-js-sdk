...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Perforation', function() {
      beforeEach(function() {
        instance = new MissionControl.Perforation();
      });

      it('should create an instance of Perforation', function() {
        // TODO: update the code to test Perforation
        expect(instance).to.be.a(MissionControl.Perforation);
      });
