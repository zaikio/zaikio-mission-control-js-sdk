...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('BoxModelPartLayoutUpdate', function() {
      beforeEach(function() {
        instance = new MissionControl.BoxModelPartLayoutUpdate();
      });

      it('should create an instance of BoxModelPartLayoutUpdate', function() {
        // TODO: update the code to test BoxModelPartLayoutUpdate
        expect(instance).to.be.a(MissionControl.BoxModelPartLayoutUpdate);
      });
      ...
      it('should have the property foldingPattern (base name: "folding_pattern")', function() {
        // TODO: update the code to test the property foldingPattern
        expect(instance).to.have.property('foldingPattern');
        // expect(instance.foldingPattern).to.be(expectedValueLiteral);
      });
