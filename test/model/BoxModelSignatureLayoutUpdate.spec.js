...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('BoxModelSignatureLayoutUpdate', function() {
      beforeEach(function() {
        instance = new MissionControl.BoxModelSignatureLayoutUpdate();
      });

      it('should create an instance of BoxModelSignatureLayoutUpdate', function() {
        // TODO: update the code to test BoxModelSignatureLayoutUpdate
        expect(instance).to.be.a(MissionControl.BoxModelSignatureLayoutUpdate);
      });
