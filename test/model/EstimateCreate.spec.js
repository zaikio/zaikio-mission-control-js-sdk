...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('EstimateCreate', function() {
      beforeEach(function() {
        instance = new MissionControl.EstimateCreate();
      });

      it('should create an instance of EstimateCreate', function() {
        // TODO: update the code to test EstimateCreate
        expect(instance).to.be.a(MissionControl.EstimateCreate);
      });
