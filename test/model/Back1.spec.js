...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Back1', function() {
      beforeEach(function() {
        instance = new MissionControl.Back1();
      });

      it('should create an instance of Back1', function() {
        // TODO: update the code to test Back1
        expect(instance).to.be.a(MissionControl.Back1);
      });
