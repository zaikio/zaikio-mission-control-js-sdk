...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('NumberLessThanCreate', function() {
      beforeEach(function() {
        instance = new MissionControl.NumberLessThanCreate();
      });

      it('should create an instance of NumberLessThanCreate', function() {
        // TODO: update the code to test NumberLessThanCreate
        expect(instance).to.be.a(MissionControl.NumberLessThanCreate);
      });
