...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('WorkstepCreate', function() {
      beforeEach(function() {
        instance = new MissionControl.WorkstepCreate();
      });

      it('should create an instance of WorkstepCreate', function() {
        // TODO: update the code to test WorkstepCreate
        expect(instance).to.be.a(MissionControl.WorkstepCreate);
      });
