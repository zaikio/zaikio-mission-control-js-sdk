...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ProductionStrategyUpdate', function() {
      beforeEach(function() {
        instance = new MissionControl.ProductionStrategyUpdate();
      });

      it('should create an instance of ProductionStrategyUpdate', function() {
        // TODO: update the code to test ProductionStrategyUpdate
        expect(instance).to.be.a(MissionControl.ProductionStrategyUpdate);
      });
