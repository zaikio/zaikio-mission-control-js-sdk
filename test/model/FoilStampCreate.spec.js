...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('FoilStampCreate', function() {
      beforeEach(function() {
        instance = new MissionControl.FoilStampCreate();
      });

      it('should create an instance of FoilStampCreate', function() {
        // TODO: update the code to test FoilStampCreate
        expect(instance).to.be.a(MissionControl.FoilStampCreate);
      });
