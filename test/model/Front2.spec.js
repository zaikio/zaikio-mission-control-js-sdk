...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Front2', function() {
      beforeEach(function() {
        instance = new MissionControl.Front2();
      });

      it('should create an instance of Front2', function() {
        // TODO: update the code to test Front2
        expect(instance).to.be.a(MissionControl.Front2);
      });
