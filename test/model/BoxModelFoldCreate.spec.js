...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('BoxModelFoldCreate', function() {
      beforeEach(function() {
        instance = new MissionControl.BoxModelFoldCreate();
      });

      it('should create an instance of BoxModelFoldCreate', function() {
        // TODO: update the code to test BoxModelFoldCreate
        expect(instance).to.be.a(MissionControl.BoxModelFoldCreate);
      });
