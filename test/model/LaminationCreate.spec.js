...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('LaminationCreate', function() {
      beforeEach(function() {
        instance = new MissionControl.LaminationCreate();
      });

      it('should create an instance of LaminationCreate', function() {
        // TODO: update the code to test LaminationCreate
        expect(instance).to.be.a(MissionControl.LaminationCreate);
      });
      ...
      it('should have the property texture (base name: "texture")', function() {
        // TODO: update the code to test the property texture
        expect(instance).to.have.property('texture');
        // expect(instance.texture).to.be(expectedValueLiteral);
      });
