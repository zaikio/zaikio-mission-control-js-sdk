...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('BoxModelRollSegmentUpdate', function() {
      beforeEach(function() {
        instance = new MissionControl.BoxModelRollSegmentUpdate();
      });

      it('should create an instance of BoxModelRollSegmentUpdate', function() {
        // TODO: update the code to test BoxModelRollSegmentUpdate
        expect(instance).to.be.a(MissionControl.BoxModelRollSegmentUpdate);
      });
