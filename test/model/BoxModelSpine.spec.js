...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('BoxModelSpine', function() {
      beforeEach(function() {
        instance = new MissionControl.BoxModelSpine();
      });

      it('should create an instance of BoxModelSpine', function() {
        // TODO: update the code to test BoxModelSpine
        expect(instance).to.be.a(MissionControl.BoxModelSpine);
      });
