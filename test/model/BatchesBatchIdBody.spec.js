...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('BatchesBatchIdBody', function() {
      beforeEach(function() {
        instance = new MissionControl.BatchesBatchIdBody();
      });

      it('should create an instance of BatchesBatchIdBody', function() {
        // TODO: update the code to test BatchesBatchIdBody
        expect(instance).to.be.a(MissionControl.BatchesBatchIdBody);
      });
