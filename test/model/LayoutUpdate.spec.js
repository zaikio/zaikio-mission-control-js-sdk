...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('LayoutUpdate', function() {
      beforeEach(function() {
        instance = new MissionControl.LayoutUpdate();
      });

      it('should create an instance of LayoutUpdate', function() {
        // TODO: update the code to test LayoutUpdate
        expect(instance).to.be.a(MissionControl.LayoutUpdate);
      });
