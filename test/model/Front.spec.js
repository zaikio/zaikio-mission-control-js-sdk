...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Front', function() {
      beforeEach(function() {
        instance = new MissionControl.Front();
      });

      it('should create an instance of Front', function() {
        // TODO: update the code to test Front
        expect(instance).to.be.a(MissionControl.Front);
      });
