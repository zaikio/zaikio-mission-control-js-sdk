...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Bleeds1', function() {
      beforeEach(function() {
        instance = new MissionControl.Bleeds1();
      });

      it('should create an instance of Bleeds1', function() {
        // TODO: update the code to test Bleeds1
        expect(instance).to.be.a(MissionControl.Bleeds1);
      });
