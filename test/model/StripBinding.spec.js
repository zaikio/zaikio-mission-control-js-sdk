...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('StripBinding', function() {
      beforeEach(function() {
        instance = new MissionControl.StripBinding();
      });

      it('should create an instance of StripBinding', function() {
        // TODO: update the code to test StripBinding
        expect(instance).to.be.a(MissionControl.StripBinding);
      });
