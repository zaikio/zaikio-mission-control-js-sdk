...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('FoilStamp', function() {
      beforeEach(function() {
        instance = new MissionControl.FoilStamp();
      });

      it('should create an instance of FoilStamp', function() {
        // TODO: update the code to test FoilStamp
        expect(instance).to.be.a(MissionControl.FoilStamp);
      });
