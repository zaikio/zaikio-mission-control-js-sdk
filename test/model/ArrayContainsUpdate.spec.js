...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ArrayContainsUpdate', function() {
      beforeEach(function() {
        instance = new MissionControl.ArrayContainsUpdate();
      });

      it('should create an instance of ArrayContainsUpdate', function() {
        // TODO: update the code to test ArrayContainsUpdate
        expect(instance).to.be.a(MissionControl.ArrayContainsUpdate);
      });
