...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DateEquals', function() {
      beforeEach(function() {
        instance = new MissionControl.DateEquals();
      });

      it('should create an instance of DateEquals', function() {
        // TODO: update the code to test DateEquals
        expect(instance).to.be.a(MissionControl.DateEquals);
      });
