...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PrintFreeMargins3', function() {
      beforeEach(function() {
        instance = new MissionControl.PrintFreeMargins3();
      });

      it('should create an instance of PrintFreeMargins3', function() {
        // TODO: update the code to test PrintFreeMargins3
        expect(instance).to.be.a(MissionControl.PrintFreeMargins3);
      });
