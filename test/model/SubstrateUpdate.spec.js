...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SubstrateUpdate', function() {
      beforeEach(function() {
        instance = new MissionControl.SubstrateUpdate();
      });

      it('should create an instance of SubstrateUpdate', function() {
        // TODO: update the code to test SubstrateUpdate
        expect(instance).to.be.a(MissionControl.SubstrateUpdate);
      });
