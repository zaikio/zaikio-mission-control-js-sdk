...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('StringEndsCreate', function() {
      beforeEach(function() {
        instance = new MissionControl.StringEndsCreate();
      });

      it('should create an instance of StringEndsCreate', function() {
        // TODO: update the code to test StringEndsCreate
        expect(instance).to.be.a(MissionControl.StringEndsCreate);
      });
