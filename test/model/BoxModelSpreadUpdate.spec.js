...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('BoxModelSpreadUpdate', function() {
      beforeEach(function() {
        instance = new MissionControl.BoxModelSpreadUpdate();
      });

      it('should create an instance of BoxModelSpreadUpdate', function() {
        // TODO: update the code to test BoxModelSpreadUpdate
        expect(instance).to.be.a(MissionControl.BoxModelSpreadUpdate);
      });
