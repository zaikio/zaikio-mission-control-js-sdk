...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ListCreate', function() {
      beforeEach(function() {
        instance = new MissionControl.ListCreate();
      });

      it('should create an instance of ListCreate', function() {
        // TODO: update the code to test ListCreate
        expect(instance).to.be.a(MissionControl.ListCreate);
      });
