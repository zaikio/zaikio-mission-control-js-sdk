...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('StringBeginsUpdate', function() {
      beforeEach(function() {
        instance = new MissionControl.StringBeginsUpdate();
      });

      it('should create an instance of StringBeginsUpdate', function() {
        // TODO: update the code to test StringBeginsUpdate
        expect(instance).to.be.a(MissionControl.StringBeginsUpdate);
      });
