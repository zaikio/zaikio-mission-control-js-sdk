...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Front3', function() {
      beforeEach(function() {
        instance = new MissionControl.Front3();
      });

      it('should create an instance of Front3', function() {
        // TODO: update the code to test Front3
        expect(instance).to.be.a(MissionControl.Front3);
      });
