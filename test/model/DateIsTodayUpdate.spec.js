...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DateIsTodayUpdate', function() {
      beforeEach(function() {
        instance = new MissionControl.DateIsTodayUpdate();
      });

      it('should create an instance of DateIsTodayUpdate', function() {
        // TODO: update the code to test DateIsTodayUpdate
        expect(instance).to.be.a(MissionControl.DateIsTodayUpdate);
      });
