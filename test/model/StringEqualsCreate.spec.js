...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('StringEqualsCreate', function() {
      beforeEach(function() {
        instance = new MissionControl.StringEqualsCreate();
      });

      it('should create an instance of StringEqualsCreate', function() {
        // TODO: update the code to test StringEqualsCreate
        expect(instance).to.be.a(MissionControl.StringEqualsCreate);
      });
