...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('BoxModelMarkCreate', function() {
      beforeEach(function() {
        instance = new MissionControl.BoxModelMarkCreate();
      });

      it('should create an instance of BoxModelMarkCreate', function() {
        // TODO: update the code to test BoxModelMarkCreate
        expect(instance).to.be.a(MissionControl.BoxModelMarkCreate);
      });
