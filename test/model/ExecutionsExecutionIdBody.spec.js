...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ExecutionsExecutionIdBody', function() {
      beforeEach(function() {
        instance = new MissionControl.ExecutionsExecutionIdBody();
      });

      it('should create an instance of ExecutionsExecutionIdBody', function() {
        // TODO: update the code to test ExecutionsExecutionIdBody
        expect(instance).to.be.a(MissionControl.ExecutionsExecutionIdBody);
      });
