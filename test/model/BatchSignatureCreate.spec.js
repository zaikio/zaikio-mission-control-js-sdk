...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('BatchSignatureCreate', function() {
      beforeEach(function() {
        instance = new MissionControl.BatchSignatureCreate();
      });

      it('should create an instance of BatchSignatureCreate', function() {
        // TODO: update the code to test BatchSignatureCreate
        expect(instance).to.be.a(MissionControl.BatchSignatureCreate);
      });
