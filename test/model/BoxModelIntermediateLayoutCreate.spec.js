...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('BoxModelIntermediateLayoutCreate', function() {
      beforeEach(function() {
        instance = new MissionControl.BoxModelIntermediateLayoutCreate();
      });

      it('should create an instance of BoxModelIntermediateLayoutCreate', function() {
        // TODO: update the code to test BoxModelIntermediateLayoutCreate
        expect(instance).to.be.a(MissionControl.BoxModelIntermediateLayoutCreate);
      });
