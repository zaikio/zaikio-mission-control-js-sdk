...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('JobStateTransitionUpdate', function() {
      beforeEach(function() {
        instance = new MissionControl.JobStateTransitionUpdate();
      });

      it('should create an instance of JobStateTransitionUpdate', function() {
        // TODO: update the code to test JobStateTransitionUpdate
        expect(instance).to.be.a(MissionControl.JobStateTransitionUpdate);
      });
