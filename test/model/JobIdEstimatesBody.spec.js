...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('JobIdEstimatesBody', function() {
      beforeEach(function() {
        instance = new MissionControl.JobIdEstimatesBody();
      });

      it('should create an instance of JobIdEstimatesBody', function() {
        // TODO: update the code to test JobIdEstimatesBody
        expect(instance).to.be.a(MissionControl.JobIdEstimatesBody);
      });
