...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AllOfordersOrderIdBodyOrder', function() {
      beforeEach(function() {
        instance = new MissionControl.AllOfordersOrderIdBodyOrder();
      });

      it('should create an instance of AllOfordersOrderIdBodyOrder', function() {
        // TODO: update the code to test AllOfordersOrderIdBodyOrder
        expect(instance).to.be.a(MissionControl.AllOfordersOrderIdBodyOrder);
      });
