...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('OrderLineItemUpdate', function() {
      beforeEach(function() {
        instance = new MissionControl.OrderLineItemUpdate();
      });

      it('should create an instance of OrderLineItemUpdate', function() {
        // TODO: update the code to test OrderLineItemUpdate
        expect(instance).to.be.a(MissionControl.OrderLineItemUpdate);
      });
