...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CommissioningUpdate', function() {
      beforeEach(function() {
        instance = new MissionControl.CommissioningUpdate();
      });

      it('should create an instance of CommissioningUpdate', function() {
        // TODO: update the code to test CommissioningUpdate
        expect(instance).to.be.a(MissionControl.CommissioningUpdate);
      });
