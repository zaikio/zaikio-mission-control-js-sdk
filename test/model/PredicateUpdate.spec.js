...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PredicateUpdate', function() {
      beforeEach(function() {
        instance = new MissionControl.PredicateUpdate();
      });

      it('should create an instance of PredicateUpdate', function() {
        // TODO: update the code to test PredicateUpdate
        expect(instance).to.be.a(MissionControl.PredicateUpdate);
      });
