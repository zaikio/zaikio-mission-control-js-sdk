...
import {FinishedProductUpdate} from './FinishedProductUpdate';
 ...
 * @version 1.0.0
 */
export class JobIdFinishedProductBody1 {
  /**
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('finished_product'))
        obj.finishedProduct = FinishedProductUpdate.constructFromObject(data['finished_product']);
    }
    return obj;
  }
}
