...
import {ExtendedShipmentUpdate} from './ExtendedShipmentUpdate';
 ...
 * @version 1.0.0
 */
export class AllOfshipmentsShipmentIdBodyShipment extends ShipmentUpdate {
  /**
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      ShipmentUpdate.constructFromObject(data, obj);
