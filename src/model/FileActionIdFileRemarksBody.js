...
import {FileRemarkCreate} from './FileRemarkCreate';
 ...
 * @version 1.0.0
 */
export class FileActionIdFileRemarksBody {
  /**
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('file_remark'))
        obj.fileRemark = FileRemarkCreate.constructFromObject(data['file_remark']);
    }
    return obj;
  }
}
