...
import {FileActionCreate} from './FileActionCreate';
 ...
 * @version 1.0.0
 */
export class FileReferenceIdFileActionsBody {
  /**
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('file_action'))
        obj.fileAction = FileActionCreate.constructFromObject(data['file_action']);
    }
    return obj;
  }
}
