...
import {BoxModelSignatureLayoutChildren} from './BoxModelSignatureLayoutChildren';
 ...
 * @version 1.0.0
 */
export class BoxModelSignatureLayout {
  /**
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('contents'))
        obj.contents = ApiClient.convertToType(data['contents'], [BoxModelSignatureLayoutChildren]);
    }
    return obj;
  }
}
