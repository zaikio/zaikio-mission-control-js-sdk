...
import {FileActionUpdate} from './FileActionUpdate';
 ...
 * @version 1.0.0
 */
export class FileActionsFileActionIdBody {
  /**
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('file_action'))
        obj.fileAction = FileActionUpdate.constructFromObject(data['file_action']);
    }
    return obj;
  }
}
