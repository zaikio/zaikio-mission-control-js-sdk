...
import {ListWithPredicatesUpdate} from './ListWithPredicatesUpdate';
 ...
 * @version 1.0.0
 */
export class AllOflistsListIdBodyList extends ListUpdate {
  /**
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      ListUpdate.constructFromObject(data, obj);
      if (data.hasOwnProperty('predicates'))
        obj.predicates = ApiClient.convertToType(data['predicates'], [PredicateUpdate]);
    }
    return obj;
  }
}
