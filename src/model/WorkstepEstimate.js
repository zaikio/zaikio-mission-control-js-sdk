...
export class WorkstepEstimate {
   ...
   */
  constructor(id, createdAt, updatedAt, estimateId, workpieceType, workpieceId, kind, description, internalLaborCosts, externalLaborCosts, durationForPreparation, durationForExecution, durationForCleanup) {
    this.id = id;
