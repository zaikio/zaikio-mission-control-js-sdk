...
export class Shipment {
   ...
   */
  constructor(id, createdAt, updatedAt, references, state, costs, incoterm, carrierKind, carrierName, carrierService, deliveryContactEmail, deliveryContactPhone, deliveryInstructions, deliveryRequirements, whiteLabel, expectedDeliveryAt, deliveredAt) {
    this.id = id;
