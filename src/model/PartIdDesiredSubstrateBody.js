...
import {DesiredSubstrateCreate} from './DesiredSubstrateCreate';
 ...
 * @version 1.0.0
 */
export class PartIdDesiredSubstrateBody {
  /**
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('desired_substrate'))
        obj.desiredSubstrate = DesiredSubstrateCreate.constructFromObject(data['desired_substrate']);
    }
    return obj;
  }
}
