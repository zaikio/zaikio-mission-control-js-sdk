 ...
 * @version 1.0.0
 */
export class ProductionStrategyIdImposingsBody {
  /**
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('imposing'))
        obj.imposing = ImposingCreate.constructFromObject(data['imposing']);
    }
    return obj;
  }
}
