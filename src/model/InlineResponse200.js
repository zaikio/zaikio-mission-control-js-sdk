...
export class InlineResponse200 extends Job {
   ...
   */
  constructor(parts, id, createdAt, updatedAt, name, references, kind, source, version, quantity, acceptableQuantityExcess, acceptableQuantityUnderrun, dueAt, estimatedCompletedAt) {
    super(id, createdAt, updatedAt, name, references, kind, source, version, quantity, acceptableQuantityExcess, acceptableQuantityUnderrun, dueAt, estimatedCompletedAt);
    this.parts = parts;
  }
