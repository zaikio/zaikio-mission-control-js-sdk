...
import {BoxModelPartLayoutChildren} from './BoxModelPartLayoutChildren';
 ...
 * @version 1.0.0
 */
export class BoxModelPartLayout {
  /**
   ...
   */
  constructor(version, format, unit, foldingPattern, contents) {
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('contents'))
        obj.contents = ApiClient.convertToType(data['contents'], [BoxModelPartLayoutChildren]);
    }
    return obj;
  }
}
