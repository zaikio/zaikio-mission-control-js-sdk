...
import {MaterialEstimateCreate} from './MaterialEstimateCreate';
 ...
 * @version 1.0.0
 */
export class WorkstepEstimateIdMaterialEstimatesBody {
  /**
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('material_estimate'))
        obj.materialEstimate = MaterialEstimateCreate.constructFromObject(data['material_estimate']);
    }
    return obj;
  }
}
