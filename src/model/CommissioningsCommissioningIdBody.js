...
import {CommissioningUpdate} from './CommissioningUpdate';
 ...
 * @version 1.0.0
 */
export class CommissioningsCommissioningIdBody {
  /**
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('commissioning'))
        obj.commissioning = CommissioningUpdate.constructFromObject(data['commissioning']);
    }
    return obj;
  }
}
