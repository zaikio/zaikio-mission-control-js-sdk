 ...
 * @version 1.0.0
 */
export class ProductionStrategiesProductionStrategyIdBody {
  /**
   ...
   */
  constructor(productionStrategy) {
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('production_strategy'))
        obj.productionStrategy = ApiClient.convertToType(data['production_strategy'], Object);
    }
    return obj;
  }
}
