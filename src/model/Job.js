...
export class Job {
   ...
   */
  constructor(id, createdAt, updatedAt, name, references, kind, source, version, quantity, acceptableQuantityExcess, acceptableQuantityUnderrun, dueAt, estimatedCompletedAt) {
    this.id = id;
