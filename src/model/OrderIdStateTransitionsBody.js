...
import {OrderStateTransitionCreate} from './OrderStateTransitionCreate';
 ...
 * @version 1.0.0
 */
export class OrderIdStateTransitionsBody {
  /**
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('state_transition'))
        obj.stateTransition = OrderStateTransitionCreate.constructFromObject(data['state_transition']);
    }
    return obj;
  }
}
