...
import {BoxModelIntermediateLayoutChildren} from './BoxModelIntermediateLayoutChildren';
 ...
 * @version 1.0.0
 */
export class BoxModelIntermediateLayout {
  /**
   ...
   */
  constructor(version, format, unit, contents) {
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('contents'))
        obj.contents = ApiClient.convertToType(data['contents'], [BoxModelIntermediateLayoutChildren]);
    }
    return obj;
  }
}
