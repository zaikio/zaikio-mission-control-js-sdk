...
import {FinishedProductCreate} from './FinishedProductCreate';
 ...
 * @version 1.0.0
 */
export class JobIdFinishedProductBody {
  /**
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('finished_product'))
        obj.finishedProduct = FinishedProductCreate.constructFromObject(data['finished_product']);
    }
    return obj;
  }
}
