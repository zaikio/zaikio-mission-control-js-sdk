...
import {WorkstepEstimate} from './WorkstepEstimate';
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('workstep_estimates'))
        obj.workstepEstimates = ApiClient.convertToType(data['workstep_estimates'], [WorkstepEstimate]);
      ...
      if (data.hasOwnProperty('total_material_costs'))
        obj.totalMaterialCosts = ApiClient.convertToType(data['total_material_costs'], 'Number');
      if (data.hasOwnProperty('total_internal_labor_costs'))
        obj.totalInternalLaborCosts = ApiClient.convertToType(data['total_internal_labor_costs'], 'Number');
      if (data.hasOwnProperty('total_external_labor_costs'))
        obj.totalExternalLaborCosts = ApiClient.convertToType(data['total_external_labor_costs'], 'Number');
      if (data.hasOwnProperty('total_internal_labor_time'))
        obj.totalInternalLaborTime = ApiClient.convertToType(data['total_internal_labor_time'], 'Number');
      if (data.hasOwnProperty('total_external_labor_time'))
        obj.totalExternalLaborTime = ApiClient.convertToType(data['total_external_labor_time'], 'Number');
      if (data.hasOwnProperty('total_duration'))
        obj.totalDuration = ApiClient.convertToType(data['total_duration'], 'Number');
