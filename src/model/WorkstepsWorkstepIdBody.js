...
import {WorkstepUpdate} from './WorkstepUpdate';
 ...
 * @version 1.0.0
 */
export class WorkstepsWorkstepIdBody {
  /**
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('workstep'))
        obj.workstep = WorkstepUpdate.constructFromObject(data['workstep']);
    }
    return obj;
  }
}
