...
import {BoxModelRollSegmentChildrenCreate} from './BoxModelRollSegmentChildrenCreate';
 ...
 * @version 1.0.0
 */
export class BoxModelRollSegmentCreate {
  /**
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('children'))
        obj.children = ApiClient.convertToType(data['children'], [BoxModelRollSegmentChildrenCreate]);
    }
    return obj;
  }
}
