 ...
 * @version 1.0.0
 */
var EstimateUpdate = /*#__PURE__*/function () {
  /**
  ...
  function EstimateUpdate() {
    _classCallCheck(this, EstimateUpdate);
  }
   ...
   */
  _createClass(EstimateUpdate, null, [{
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new EstimateUpdate();
        if (data.hasOwnProperty('workstep_estimates')) obj.workstepEstimates = _ApiClient.ApiClient.convertToType(data['workstep_estimates'], [_WorkstepEstimateUpdate.WorkstepEstimateUpdate]);
 ...
 */
exports.EstimateUpdate = EstimateUpdate;
