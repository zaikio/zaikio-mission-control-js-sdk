...
var Box = /*#__PURE__*/function () {
   ...
   */
  function Box(children, id, kind, position, dimensions, orientation, bleeds, printFreeMargins, pageNumbers, reference) {
  ...
  _createClass(Box, null, [{
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new Box();
        if (data.hasOwnProperty('children')) obj.children = _ApiClient.ApiClient.convertToType(data['children'], [Box]);
