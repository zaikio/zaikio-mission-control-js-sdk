...
exports.AllOfordersBodyOrder = void 0;
var _ApiClient = require("../ApiClient");
var _ContactCreate = require("./ContactCreate");
var _ExpandedOrderCreate = require("./ExpandedOrderCreate");
var _OrderCreate2 = require("./OrderCreate");
 ...
 * @version 1.0.0
 */
var AllOfordersBodyOrder = /*#__PURE__*/function (_OrderCreate) {
  _inherits(AllOfordersBodyOrder, _OrderCreate);
  var _super = _createSuper(AllOfordersBodyOrder);
  /**
   ...
   */
  function AllOfordersBodyOrder() {
    _classCallCheck(this, AllOfordersBodyOrder);
   ...
   */
  _createClass(AllOfordersBodyOrder, null, [{
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new AllOfordersBodyOrder();
        _OrderCreate2.OrderCreate.constructFromObject(data, obj);
  ...
  return AllOfordersBodyOrder;
}(_OrderCreate2.OrderCreate);
/**
 * @member {Object} address
 */
exports.AllOfordersBodyOrder = AllOfordersBodyOrder;
