...
exports.OneOfExpandedOrderCreatePaymentTerms = void 0;
 ...
 * @version 1.0.0
 */
var OneOfExpandedOrderCreatePaymentTerms = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>OneOfExpandedOrderCreatePaymentTerms</code>.
   * @alias module:model/OneOfExpandedOrderCreatePaymentTerms
   * @class
   */
  function OneOfExpandedOrderCreatePaymentTerms() {
    _classCallCheck(this, OneOfExpandedOrderCreatePaymentTerms);
  }
   ...
   */
  _createClass(OneOfExpandedOrderCreatePaymentTerms, null, [{
  ...
  return OneOfExpandedOrderCreatePaymentTerms;
}();
exports.OneOfExpandedOrderCreatePaymentTerms = OneOfExpandedOrderCreatePaymentTerms;