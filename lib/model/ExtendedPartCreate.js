...
exports.ExtendedPartCreate = void 0;
...
/**
 * The ExtendedPartCreate model module.
 * @module model/ExtendedPartCreate
 * @version 1.0.0
 */
var ExtendedPartCreate = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>ExtendedPartCreate</code>.
   * @alias module:model/ExtendedPartCreate
   * @class
   */
  function ExtendedPartCreate() {
    _classCallCheck(this, ExtendedPartCreate);
  }

  /**
   * Constructs a <code>ExtendedPartCreate</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ExtendedPartCreate} obj Optional instance to populate.
   * @return {module:model/ExtendedPartCreate} The populated <code>ExtendedPartCreate</code> instance.
   */
  _createClass(ExtendedPartCreate, null, [{
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new ExtendedPartCreate();
        if (data.hasOwnProperty('layout')) obj.layout = _ApiClient.ApiClient.convertToType(data['layout'], Object);
        if (data.hasOwnProperty('colors')) obj.colors = _ApiClient.ApiClient.convertToType(data['colors'], [_ColorCreate.ColorCreate]);
        ...
        if (data.hasOwnProperty('finishing_applications')) obj.finishingApplications = _ApiClient.ApiClient.convertToType(data['finishing_applications'], [_FinishingApplicationCreate.FinishingApplicationCreate]);
        if (data.hasOwnProperty('finishings')) obj.finishings = _ApiClient.ApiClient.convertToType(data['finishings'], [_FinishingCreate.FinishingCreate]);
  ...
  return ExtendedPartCreate;
}();
/**
 * @member {Object} layout
 */
exports.ExtendedPartCreate = ExtendedPartCreate;
ExtendedPartCreate.prototype.layout = undefined;

/**
 * @member {Array.<module:model/ColorCreate>} colors
 */
ExtendedPartCreate.prototype.colors = undefined;

/**
 * @member {Object} desiredSubstrate
 */
ExtendedPartCreate.prototype.desiredSubstrate = undefined;

/**
 * @member {Array.<module:model/FinishingApplicationCreate>} finishingApplications
 */
ExtendedPartCreate.prototype.finishingApplications = undefined;

/**
 * @member {Array.<module:model/FinishingCreate>} finishings
 */
ExtendedPartCreate.prototype.finishings = undefined;

/**
 * @member {Array.<module:model/FileReferenceCreate>} fileReferences
 */
ExtendedPartCreate.prototype.fileReferences = undefined;
 ...
 * @member {module:model/ExtendedPartCreate.KindEnum} kind
 */
ExtendedPartCreate.prototype.kind = undefined;
 ...
 * @readonly
 */
ExtendedPartCreate.ContentEnum = {
  /**
   * value: "single_page"
   * @const
   */
 ...
 * @member {module:model/ExtendedPartCreate.ContentEnum} content
 */
ExtendedPartCreate.prototype.content = undefined;
 ...
 * @member {Number} pages
 */
ExtendedPartCreate.prototype.pages = undefined;
 ...
 */
ExtendedPartCreate.prototype.dimensions = undefined;
 ...
 * @readonly
 */
ExtendedPartCreate.DimensionsUnitEnum = {
  /**
   * value: "cm"
   * @const
   */
 ...
 * @member {module:model/ExtendedPartCreate.DimensionsUnitEnum} dimensionsUnit
 */
ExtendedPartCreate.prototype.dimensionsUnit = undefined;