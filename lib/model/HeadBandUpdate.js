...
/**
 * The HeadBandUpdate model module.
 * @module model/HeadBandUpdate
 * @version 1.0.0
 */
var HeadBandUpdate = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>HeadBandUpdate</code>.
   * @alias module:model/HeadBandUpdate
   * @class
   */
  function HeadBandUpdate() {
    _classCallCheck(this, HeadBandUpdate);
  }

  /**
   * Constructs a <code>HeadBandUpdate</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/HeadBandUpdate} obj Optional instance to populate.
   * @return {module:model/HeadBandUpdate} The populated <code>HeadBandUpdate</code> instance.
   */
  _createClass(HeadBandUpdate, null, [{
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new HeadBandUpdate();
  ...
  return HeadBandUpdate;
}();
/**
 * @member {Array.<module:model/FileReferenceUpdate>} fileReferences
 */
exports.HeadBandUpdate = HeadBandUpdate;
HeadBandUpdate.prototype.fileReferences = undefined;
 ...
 * @member {module:model/HeadBandUpdate.KindEnum} kind
 */
HeadBandUpdate.prototype.kind = undefined;
 ...
 * @readonly
 */
HeadBandUpdate.DimensionsUnitEnum = {
  /**
   * value: "cm"
   * @const
   */
 ...
 * @member {module:model/HeadBandUpdate.DimensionsUnitEnum} dimensionsUnit
 */
HeadBandUpdate.prototype.dimensionsUnit = undefined;
