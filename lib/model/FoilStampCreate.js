...
exports.FoilStampCreate = void 0;
...
/**
 * The FoilStampCreate model module.
 * @module model/FoilStampCreate
 * @version 1.0.0
 */
var FoilStampCreate = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>FoilStampCreate</code>.
   * @alias module:model/FoilStampCreate
   * @class
   */
  function FoilStampCreate() {
    _classCallCheck(this, FoilStampCreate);
  }

  /**
   * Constructs a <code>FoilStampCreate</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/FoilStampCreate} obj Optional instance to populate.
   * @return {module:model/FoilStampCreate} The populated <code>FoilStampCreate</code> instance.
   */
  _createClass(FoilStampCreate, null, [{
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new FoilStampCreate();
  ...
  return FoilStampCreate;
}();
/**
 * @member {Array.<module:model/FileReferenceCreate>} fileReferences
 */
exports.FoilStampCreate = FoilStampCreate;
FoilStampCreate.prototype.fileReferences = undefined;
 ...
 * @member {module:model/FoilStampCreate.KindEnum} kind
 */
FoilStampCreate.prototype.kind = undefined;
 ...
 * @member {module:model/FoilStampCreate.DirectionEnum} direction
 */
FoilStampCreate.prototype.direction = undefined;
 ...
 * @member {module:model/FoilStampCreate.ColorEnum} color
 */
FoilStampCreate.prototype.color = undefined;
