...
/**
 * The WorkstepUpdate model module.
 * @module model/WorkstepUpdate
 * @version 1.0.0
 */
var WorkstepUpdate = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>WorkstepUpdate</code>.
   * @alias module:model/WorkstepUpdate
   * @class
   */
  function WorkstepUpdate() {
    _classCallCheck(this, WorkstepUpdate);
  }

  /**
   * Constructs a <code>WorkstepUpdate</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/WorkstepUpdate} obj Optional instance to populate.
   * @return {module:model/WorkstepUpdate} The populated <code>WorkstepUpdate</code> instance.
   */
  _createClass(WorkstepUpdate, null, [{
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new WorkstepUpdate();
  ...
  return WorkstepUpdate;
}();
/**
 * @member {String} id
 */
exports.WorkstepUpdate = WorkstepUpdate;
WorkstepUpdate.prototype.id = undefined;
...
/**
 * @member {module:model/WorkstepUpdate.KindEnum} kind
 */
WorkstepUpdate.prototype.kind = undefined;
 ...
 * @member {module:model/WorkstepUpdate.StateEnum} state
 */
WorkstepUpdate.prototype.state = undefined;

/**
 * The ID of the group this workstep is part of
 * @member {String} groupingId
 */
WorkstepUpdate.prototype.groupingId = undefined;

/**
 * # TODO
 * @member {Number} expectedCostsForWork
 */
WorkstepUpdate.prototype.expectedCostsForWork = undefined;

/**
 * # TODO
 * @member {Number} expectedCostsForMaterials
 */
WorkstepUpdate.prototype.expectedCostsForMaterials = undefined;

/**
 * # TODO
 * @member {Number} expectedDurationForPreparation
 */
WorkstepUpdate.prototype.expectedDurationForPreparation = undefined;

/**
 * # TODO
 * @member {Number} expectedDurationForExecution
 */
WorkstepUpdate.prototype.expectedDurationForExecution = undefined;

/**
 * # TODO
 * @member {Number} expectedDurationForCleanup
 */
WorkstepUpdate.prototype.expectedDurationForCleanup = undefined;

/**
 * # TODO
 * @member {Number} actualCostsForWork
 */
WorkstepUpdate.prototype.actualCostsForWork = undefined;

/**
 * # TODO
 * @member {Number} actualCostsForMaterials
 */
WorkstepUpdate.prototype.actualCostsForMaterials = undefined;

/**
 * # TODO
 * @member {Number} actualDurationForPreparation
 */
WorkstepUpdate.prototype.actualDurationForPreparation = undefined;

/**
 * # TODO
 * @member {Number} actualDurationForExecution
 */
WorkstepUpdate.prototype.actualDurationForExecution = undefined;

/**
 * # TODO
 * @member {Number} actualDurationForCleanup
 */
WorkstepUpdate.prototype.actualDurationForCleanup = undefined;

/**
 * # TODO
 * @member {Number} actualDurationForException
 */
WorkstepUpdate.prototype.actualDurationForException = undefined;