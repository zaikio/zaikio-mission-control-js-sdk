 ...
 * @version 1.0.0
 */
var ImposingCreate = /*#__PURE__*/function () {
  /**
   ...
   */
  function ImposingCreate(partId) {
    _classCallCheck(this, ImposingCreate);
    this.partId = partId;
  }
   ...
   */
  _createClass(ImposingCreate, null, [{
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('signatures')) obj.signatures = _ApiClient.ApiClient.convertToType(data['signatures'], [_SignatureCreate.SignatureCreate]);
        if (data.hasOwnProperty('substrate')) obj.substrate = _ApiClient.ApiClient.convertToType(data['substrate'], Object);
      }
      return obj;
    }
  }]);
  return ImposingCreate;
}();
/**
 * The ID of the Part this Imposing provides
 * @member {String} partId
 */
exports.ImposingCreate = ImposingCreate;
